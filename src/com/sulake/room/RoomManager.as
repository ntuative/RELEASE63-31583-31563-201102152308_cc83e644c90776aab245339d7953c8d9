package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1637:int = 0;
      
      public static const const_1543:int = 1;
      
      public static const const_1120:int = 2;
      ...
      private var var_2798:IRoomContentLoader;
      
      private var var_610:IRoomObjectFactory = null;
      
      private var var_505:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1147:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_609 = [];
         this.var_580 = [];
         events.addEventListener(RoomContentLoadedEvent.const_369,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_561,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_610 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_610 == null || this.var_505 == null)
         {
            return;
         }
         this._state = const_1543;
         if(this.var_1147 != null)
         {
            _loc1_ = this.var_1147;
            this.var_1147 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_609.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_610.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_610 != null)
         {
            return this.var_610.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_816)
         {
            return;
         }
         if(this.var_49 == null)
         {
            this._state = const_816;
            return;
         }
         if(this.var_49.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_609.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_609.splice(_loc2_,1);
            }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_49 == null || this.var_505 == null)
         {
            return;
         }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_610.createRoomObjectLogic(_loc18_);
