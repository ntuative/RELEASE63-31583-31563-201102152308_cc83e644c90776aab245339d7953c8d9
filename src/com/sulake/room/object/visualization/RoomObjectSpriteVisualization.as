   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_192 != null)
         {
            ...
            {
               _loc1_ = this.var_192[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_742.removeReference();
         }
         this.var_742 = param1;
         if(this.var_742 != null)
         {
            this.var_742.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_192.length > param1)
         {
            _loc2_ = this.var_192[this.var_192.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
