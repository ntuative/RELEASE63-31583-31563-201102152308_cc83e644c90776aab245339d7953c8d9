package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1677:int = 50;
      ...
      private var var_587:RoomObjectCache;
      
      private var var_493:Array;
      
      private var var_588:Array;
      
      private var var_1365:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2361:Number = -1.0E7;
      
      private var var_2364:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_246.addChild(this.var_58);
         ...
         this.var_587 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_492.x -= param1 - this.var_589;
         this.var_589 = param1;
      }
      
      public function set method_2(param1:int) : void
      {
         this.var_492.y -= param1 - this.var_590;
         this.var_590 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_855 = true;
            if(this.var_126 != null && !this.var_246.contains(this.var_126))
            {
               this.var_246.addChild(this.var_126);
               this.var_58.mask = this.var_126;
            }
         }
         else if(!param1 && this.var_855)
         {
            this.var_855 = false;
            if(this.var_126 != null && this.var_246.contains(this.var_126))
            {
               this.var_246.removeChild(this.var_126);
      ...
      {
         this.var_587.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_730 != this.var_2363 || this._ht != this.var_2362)
         {
            _loc9_ = true;
         }
         if(this.var_58.x != this.var_589 || this.var_58.y != this.var_590)
         {
            this.var_58.x = this.var_589;
            this.var_58.y = this.var_590;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_493.sortOn("z",0 | 0);
         if(_loc5_ < this.var_493.length)
         {
            this.var_493.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_493[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2363 = this.var_730;
         this.var_2362 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_587.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_587.getObjectCache(param2);
         ...
         if(!_loc9_.method_8(_loc6_.getInstanceId(),_loc6_.getUpdateID()) && !param4)
         {
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc19_ < this.var_730 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.method_8(_loc3_.instanceId,_loc3_.updateId))
            {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_731 || this.var_731 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_493.length)
         {
            return null;
         }
         return this.var_493[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_589;
         param2 -= this.var_590;
         this.var_492.x = param1;
         this.var_492.y = param2;
         if(this.var_1098 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1718;
         }
         this.var_1718 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1098;
         return this.var_1718;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_730 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1717,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2361 || param2 != this.var_2364)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_350 != null && param1 != null)
         {
            this.var_350.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_350 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_350.getKey(_loc1_);
            _loc3_ = this.var_350.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1365.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1098 == 0)
         {
            this.checkMouseHits(this.var_492.x,this.var_492.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1098 = 0;
         ++this.var_1717;
      }
