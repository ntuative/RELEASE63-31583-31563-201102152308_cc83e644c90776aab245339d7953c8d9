package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_1860:Number = 1.0;
      
      private var var_77:Vector3d;
      
      private var var_260:Vector3d;
      
      private var var_2772:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1860 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_77.x * this.var_430,this.var_77.y * this.var_429,this.var_77.z * this.var_428);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_260.x,this.var_260.y,this.var_260.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_430 != param1 * this.var_1861)
         {
            this.var_430 = param1 * this.var_1861;
            ++this.var_158;
         }
      }
      ...
      {
         if(this.var_429 != param1 * this.var_1862)
         {
            this.var_429 = param1 * this.var_1862;
            ++this.var_158;
         }
      }
      ...
      {
         if(this.var_428 != param1 * this.var_1860)
         {
            this.var_428 = param1 * this.var_1860;
            ++this.var_158;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_77.x /= this.var_430;
         this.var_77.y /= this.var_429;
         this.var_77.z /= this.var_428;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_260.x;
         var _loc3_:Number = this.var_260.y;
         var _loc4_:Number = this.var_260.z;
         this.var_260.assign(param1);
         if(this.var_260.x != _loc2_ || this.var_260.y != _loc3_ || this.var_260.z != _loc4_)
         {
            ++this.var_158;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_140.assign(_loc24_);
            this.var_141.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_140.assign(_loc19_);
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1174.assign(_loc22_);
         }
         else
         {
            this.var_1174.assign(_loc17_);
         }
         ++this.var_158;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_140);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_430;
         _loc2_.y *= this.var_429;
         _loc2_.z *= this.var_428;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1174);
         if(_loc3_ < this.var_2772 || _loc3_ > this.var_2773)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_140);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_429;
            _loc2_.z *= this.var_428;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1174);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_140,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_77.x * this.var_430,this.var_77.y * this.var_429,this.var_77.z * this.var_428);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_141;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_430,param2.y * this.var_429,param2.z * this.var_428);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_430,param3.y * this.var_429,param3.z * this.var_428);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_430,param4.y * this.var_429,param4.z * this.var_428);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_640;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_640;
      }
