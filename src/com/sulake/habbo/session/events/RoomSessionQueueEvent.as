package com.sulake.habbo.session.events
{
   ...
   public class RoomSessionQueueEvent extends RoomSessionEvent
   {
      ...
      public static const const_574:String = "RSQE_QUEUE_STATUS";
      
      public static const const_1154:String = "c";
      
      public static const const_1366:String = "d";
      ...
      {
         super(const_574,param1,param5,param6);
         this._name = param2;
         this._target = param3;
