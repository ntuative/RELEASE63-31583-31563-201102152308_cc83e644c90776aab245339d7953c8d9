package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1007.getValue());
      ...
      {
         this.var_88 = param2;
         this.var_1007 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_1007.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_1007.setValue(1);
         this.var_1006 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1006.addEventListener(Event.CHANGE,this.onCounterSliderChange);
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1007.setValue(_loc3_);
         this.var_1006.setValue(_loc4_);
      }
