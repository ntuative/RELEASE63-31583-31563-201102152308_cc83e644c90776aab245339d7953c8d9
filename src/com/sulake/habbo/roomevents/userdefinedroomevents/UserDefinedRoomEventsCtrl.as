package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1636:TriggerConfs;
      
      private var var_1637:ActionTypes;
      
      private var var_1638:ConditionTypes;
      
      private var var_239:Dictionary;
      
      private var var_60:Triggerable;
      
      private var var_707:RoomObjectHightLighter;
      
      private var var_172:UserDefinedRoomEventsHelp;
      
      private var var_1058:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1636 = new TriggerConfs();
         this.var_1637 = new ActionTypes();
         this.var_1638 = new ConditionTypes();
         this.var_239 = new Dictionary();
         super();
         this.var_88 = param1;
         this.var_707 = new RoomObjectHightLighter(param1);
         this.var_172 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1058 = new SliderWindowController(this.var_88,IWindowContainer(this.find(this.var_89,"delay_slider_container")),this.var_88.assets,0,20,1);
         this.var_1058.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1058.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_707.hideAll(this.var_239);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_707.showAll(this.var_239);
         if(this.var_60 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_60);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1058.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_60 as TriggerDefinition != null)
         {
            this.var_88.send(new UpdateTriggerMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_60 as ActionDefinition != null)
         {
            this.var_88.send(new UpdateActionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_60 as ConditionDefinition != null)
         {
            this.var_88.send(new UpdateConditionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1058.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_172.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.send(new ApplySnapshotMessageComposer(this.var_60.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1636);
         this.refreshConfigureElement(this.var_1637);
         this.refreshConfigureElement(this.var_1638);
