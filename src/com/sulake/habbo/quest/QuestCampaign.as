package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_511:Quest;
      
      private var var_304:QuestView;
      ...
      private var var_305:IItemListWindow;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_172 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_365)
         {
            ...
            {
               this.var_305.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_365 = null;
            this.var_305.destroyListItems();
            this.var_305.removeListItems();
         }
         this.var_511 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1167 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1435 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_305 = this._window.findChildByName("quests") as IItemListWindow;
         ...
         this.var_1435.findChildByName("currency.amount").caption = "${quest_" + this.var_1845 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1168 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1168)
         {
            this.var_1168.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1168.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1168.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_511)
         {
            this.var_511.selected = false;
         }
         if(this.var_172)
         {
            this.var_1167.addChild(this.var_172.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1585);
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_365.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_365)
         {
            this.var_305.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_42 || _loc4_.status == QuestStatusEnum.const_458))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_305.maxScrollV > 0)
            {
               this.var_305.scrollV = _loc3_.view.y / this.var_305.maxScrollV;
            }
         }
         else if(this.var_365.length > 0)
         {
            this.activateListItem(this.var_365[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_511 = param1;
         this.var_511.selected = true;
         this.showQuestData(this.var_511);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_304 = new QuestView(this,param1);
         this.var_1167.addChild(this.var_304.view);
         this.var_304.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_769.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_769)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_769.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_365[_loc3_] = _loc5_;
            _loc6_ = this.var_305.getListItemIndex(_loc2_.view);
            this.var_305.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_305.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_305.addListItem(_loc5_.view);
            }
            if(this.var_511 == _loc2_)
            {
