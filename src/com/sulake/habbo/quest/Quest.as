package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2058:uint = 2;
      
      private var var_2057:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1721 = param1.roomItemTypeName;
         this.var_1720 = param1.rewardCurrencyAmount;
         this.var_1512 = new Date();
         this.var_1512.setTime(param1.endDateTimeStamp);
         this.var_732 = param1.localizationCode;
      ...
      private function createView() : void
      {
         switch(this.var_375)
         {
            case QuestStatusEnum.const_42:
               ...
               break;
            case QuestStatusEnum.const_458:
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_63.code,this.var_732].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_200)
            {
               this.var_813.style = this.var_2057;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_200)
            {
               this.var_813.style = this.var_2058;
            }
         }
      }
