package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_677:IAlertDialog;
      ...
      private function onAvailableQuestCampaign(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length == 0)
         {
            ...
            this.var_677 = this.var_144.windowManager.alert("quest.nocampaigns.title","quest.nocampaigns.desc",0,this.onCloseAlert);
         }
         else
         {
      ...
      private function onRoomExit(param1:IMessageEvent) : void
      {
         ...
         this.var_144.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_157,HabboToolbarIconEnum.QUESTS));
      }
