package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_209 = IFrameWindow(this.var_63.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_209.findChildByName("description").caption = this.var_63.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_209.findChildByName("reward.currency.desc").caption = this.var_63.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
