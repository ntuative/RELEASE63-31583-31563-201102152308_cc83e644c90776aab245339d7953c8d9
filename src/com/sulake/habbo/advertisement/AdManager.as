package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1053:BitmapData = null;
      
      private var var_1052:BitmapData = null;
      ...
      {
         this.var_299 = param2 as IHabboCommunicationManager;
         if(this.var_299 == null)
         {
            return;
         }
         this._connection = this.var_299.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2240 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2241 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2242 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1634 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1054 == 0)
         {
            this.var_1054 = getTimer();
            return false;
         }
         if(this.var_1634 > 0 && this.var_1633 >= this.var_1634)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1054;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1317 = _loc2_.imageUrl;
         this.var_2243 = _loc2_.clickUrl;
         this.var_1054 = getTimer();
         if(this.var_1317 != "")
         {
            _loc3_ = this.var_1317;
            ...
            {
               this.var_208 = new Timer(this.var_2242,1);
            ...
            this.var_208.start();
            _loc4_ = new URLRequest(this.var_1317);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_525,0,0,param1.bitmapData,this.var_2243));
            this.var_1054 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_528));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1318 = _loc2_.imageUrl;
         this.var_1632 = _loc2_.clickUrl;
         if(this.var_1318 != "" && this.var_1632 != "")
         {
            _loc3_ = this.var_1318;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1318);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_521,0,0,_loc4_,this.var_1632,this.var_1053,this.var_1052));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1053 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1052 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
