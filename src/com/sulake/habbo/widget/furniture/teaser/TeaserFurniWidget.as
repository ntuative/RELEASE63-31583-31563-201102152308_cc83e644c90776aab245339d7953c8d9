package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1693:int = 0;
      
      private const const_1694:int = 1;
      
      private const const_1696:int = 2;
      
      private const const_1697:int = 3;
      
      private const const_1695:int = 4;
      
      private const const_1967:int = 0;
      
      private const const_1966:int = 1;
      
      private const const_1969:int = 2;
      
      private const const_1968:int = 3;
      
      private const const_1965:int = 4;
      
      private const const_1971:int = 5;
      
      private const const_1698:String = "deco_img";
      
      private const const_1692:String = "dialog_bg";
      
      private const const_1972:String = "%campaign%_dialog_bg.png";
      
      private const const_326:String = "%campaign%_gift_package.png";
      
      private const const_1970:String = "%campaign%_gift_content.png";
      
      private const const_1964:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this._imageUrlPath = this.var_156.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1422.length)
         {
            _loc2_ = this.var_1422.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_156 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_519,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_639,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_736,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_519,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_519:
               _loc2_ = this.const_1693;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_736:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     ...
                     var_83.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
               ...
               this._shareId = null;
               this.var_1420 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_639:
               _loc2_ = this.const_1694;
               this.var_353 = param1.objectId;
               this._shareId = param1.data;
               this.var_375 = param1.status;
               this.var_1420 = param1.itemCategory;
               var_83.registerParameter("notifications.viral_furni.fb.title","realname",param1.ownRealName);
               var_83.registerParameter("notifications.viral_furni.fb.desc","realname",param1.ownRealName);
               var_83.registerParameter("widget.furni.teaser.gift.unlocked.desc","username",param1.firstClickUserName);
               break;
            default:
               Logger.log("Error, invalid viral widget update message: " + param1.type);
         }
         if(this._window && (this.var_1421 != _loc2_ || _loc3_ != this.var_179))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_179 = _loc3_;
         this.var_1421 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1421)
            {
               ...
               case this.const_1694:
                  ...
                  else if(this.var_375 == this.const_1966)
                  {
                     ...
                     _loc2_ = this.const_1970;
                  }
                  else if(this.var_375 == this.const_1969)
                  {
                     ...
                     _loc3_ = var_83.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_83.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_326;
                  }
                  else if(this.var_375 == this.const_1968)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_179,"client.show.not_enough_fb_friends");
                     _loc3_ = var_83.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_83.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_326;
                  }
                  else if(this.var_375 == this.const_1965)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_179,"client.show.not_enough_fb_friends");
                     _loc3_ = var_83.getKey("widget.furni.teaser.gift.no_min_fb_friends.title");
                     _loc4_ = var_83.getKey("widget.furni.teaser.gift.no_min_fb_friends.desc");
                     _loc2_ = this.const_326;
                  }
                  else if(this.var_375 == this.const_1971)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_179,"client.show.campaign_closed");
                     _loc3_ = var_83.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                     _loc4_ = var_83.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
                     _loc2_ = this.const_326;
                  }
                  break;
            ...
            _loc5_ = this.const_1972.replace("%campaign%",this.var_179);
            this.setDecoImage(_loc5_,this.const_1692);
            _loc2_ = _loc2_.replace("%campaign%",this.var_179);
            this.setDecoImage(_loc2_,this.const_1698);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_759);
      ...
      {
         var _loc2_:String = var_83.getKey("notifications.viral_furni.fb.title");
         var _loc3_:String = var_83.getKey("notifications.viral_furni.fb.desc");
         this.sendConversionPoint("viral_" + this.var_179,"client.start_post",this._shareId);
         var _loc4_:String = this.var_156.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_179,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1420 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1420 == 1 ? "null" : InventoryCategory.const_122);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_771,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1422.push(new ImageDownloader(this,_assets,this.var_179,this._imageUrlPath,param1,param2));
            return;
         }
