package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1080:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1079 = 0;
         this.var_1080 = param2.rectangle.clone();
         this.var_1080.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1080.width)
         {
            return false;
         }
         if(this.var_1079 + param1.height > this.var_1080.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1080.width)
         {
            this._offsetX = 0;
            this.var_1079 += param1.height + this.const_1956;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1079);
         this._offsetX += param1.width + this.const_1955;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1351 != null && this.var_1351.indexOf(param1) != -1)
         {
