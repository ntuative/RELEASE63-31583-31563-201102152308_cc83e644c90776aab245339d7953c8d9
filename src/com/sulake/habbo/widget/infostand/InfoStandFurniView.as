package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_979 = this.var_195.findChildByTag("catalog");
         if(this.var_979 != null)
         {
            this.var_979.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_51.addListItem(this.var_979);
            }
            this.var_979.visible = param1;
         }
         else
         {
            this.var_51.removeListItem(this.var_979);
         }
      }
   }
}
