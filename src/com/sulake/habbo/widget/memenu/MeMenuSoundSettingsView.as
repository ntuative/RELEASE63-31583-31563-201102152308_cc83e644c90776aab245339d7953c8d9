package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_957:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_486 = param1.volume;
         if(this.var_957 != null)
         {
            this.var_957.setValue(this.var_486);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_957 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_486 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1855);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1856);
         }
      }
