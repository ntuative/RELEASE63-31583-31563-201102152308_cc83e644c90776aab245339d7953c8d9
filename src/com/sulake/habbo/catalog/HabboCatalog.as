package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_355:ICatalogNavigator;
      ...
      private var var_217:PurchaseConfirmationDialog;
      
      private var var_290:ChargeConfirmationDialog;
      ...
      private var var_2371:GiftWrappingConfiguration;
      
      private var var_1101:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_217 == null)
            {
               this.var_217 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_217.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_355.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_98.getActivityPointsForType(Purse.const_186)));
         var _loc1_:int = 0;
      ...
      {
         this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_355 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1101 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_355.buildCatalogIndex(_loc2_);
         if(this.var_734 && this.var_734 != "")
         {
            this.var_355.openPage(this.var_734);
            this.var_734 = "";
            this.var_896 = -1;
         }
         else if(this.var_896 > -1)
         {
            this.var_355.openPageById(this.var_896,this.var_1728);
            this.var_896 = -1;
            this.var_1728 = -1;
            this.var_734 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2372 && this.var_593 != null)
         {
            this.var_593.playSound(HabboSoundTypesEnum.const_1121);
         }
         this.var_2372 = false;
         if(this.var_290 != null)
         {
            this.var_290.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_65,this.var_98.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2370 && this.var_593 != null)
         {
            this.var_593.playSound(HabboSoundTypesEnum.const_979);
         }
         this.var_2370 = false;
         if(this.var_290 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1101.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2371 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_217 != null)
         {
            this.var_217.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_290 == null)
         {
            this.var_290 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_290.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_289.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.petType,_loc3_.slice()));
         }
      }
