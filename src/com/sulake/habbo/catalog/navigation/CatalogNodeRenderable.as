package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1351:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1469:XML;
      
      private static var var_1468:XML;
       
      
      private var var_1917:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1468 == null)
         {
            ...
            var_1468 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1917 == 4294967295)
            {
               this.var_1917 = _loc1_.color;
            }
            _loc1_.color = const_1351;
         }
      }
      ...
      {
         this.var_54 = navigator.catalog.windowManager.buildFromXML(var_1468) as IItemListWindow;
         if(this.var_54 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1469) as IWindowContainer;
         }
         else
         {
