package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_616 != const_949;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1835 != RecyclerStatusMessageEvent.const_1127;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_616 == const_413;
      }
      ...
      {
         this.var_616 = const_950;
         this.var_116 = new Array(const_175);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1412:
               this.var_616 = const_413;
               if(this._view == null)
               {
                  return;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1072:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1470:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_116.length < const_175)
         {
            return false;
         }
         var _loc1_:int = 0;
