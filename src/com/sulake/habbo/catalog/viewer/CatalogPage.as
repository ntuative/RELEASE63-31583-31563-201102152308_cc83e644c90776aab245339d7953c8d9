package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1653:String = "ctlg_";
      ...
      private var var_1005:ICatalogViewer;
      ...
      private var var_469:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1050:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_469 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1049);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1049);
      }
      ...
      {
         var _loc2_:String = const_1653 + param1;
         ...
         this.var_1973 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1973) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1566:
               if(this.var_1050 == null)
               {
                  this.var_1050 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1050);
               }
               break;
            case CatalogWidgetEnum.const_1516:
               this.var_47.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1369:
            ...
            case CatalogWidgetEnum.const_1608:
               ...
               break;
            case CatalogWidgetEnum.const_1419:
            ...
            case CatalogWidgetEnum.const_1469:
               ...
               break;
            case CatalogWidgetEnum.const_1548:
               this.var_47.push(new TextInputCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1487:
            ...
            case CatalogWidgetEnum.const_1574:
               ...
               break;
            case CatalogWidgetEnum.const_1550:
               this.var_47.push(new MarketPlaceCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1379:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_469.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_469 != null)
         {
            return this.var_469.dispatchEvent(param1);
         }
         return false;
      }
   }
