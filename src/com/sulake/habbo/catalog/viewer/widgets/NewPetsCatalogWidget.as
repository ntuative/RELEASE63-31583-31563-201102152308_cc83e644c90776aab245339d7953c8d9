package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1214:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_380 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_380 < 8)
         {
            return false;
         }
         this.updateAvailableBreeds(this.var_380);
         if(this.var_204 != null && this.var_204.length > 0)
         {
            this.var_321 = this.var_204[0];
         }
         else
         {
            this.var_321 = -1;
         }
         this._offers.add(this.var_380,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_204 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1214 && _loc2_ < this.var_204.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_380,this.var_204[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_204 != null && this.var_204.length > 0)
         {
            ...
            this.var_321 = this.var_204[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_380,this.var_321),this.getRaceLocalizationKey(this.var_380,this.var_321));
            }
         }
         return this.getRaceLocalizationKey(this.var_380,this.var_321);
      }
      ...
      {
         if(param1.petType == this.var_380)
         {
            this.var_204 = param1.sellableBreeds;
            this.initializeBreedSelection();
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_321 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_380;
         var _loc3_:int = this.var_321;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_321 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function updateAvailableBreeds(param1:int) : void
      {
         if(this.var_204 == null)
         {
            this.var_204 = (page.viewer.catalog as HabboCatalog).getSellablePetBreeds(param1);
         }
      }
