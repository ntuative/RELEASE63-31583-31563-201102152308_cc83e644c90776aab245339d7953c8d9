package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_840:ITextWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_840 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1023 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1561 = new Point(this.var_82.x,this.var_82.y);
         this.var_457 = _window.findChildByName("bundleGrid") as IItemGridWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_840.text = _loc4_;
         this.var_1023.text = _loc5_;
         this.var_840.height = this.var_840.textHeight + 5;
         this.var_1023.y = this.var_840.y + this.var_840.height;
         this.var_1023.height = Math.max(130,this.var_1023.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_511:
                  _loc6_ = this.var_1562.clone();
                  if(this.var_457 != null)
                  {
                     this.var_457.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_457,this.var_1273,this.var_1502);
                     this.var_457.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_255:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_302,AvatarAction.const_492);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2127)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1561.x;
            this.var_82.y = this.var_1561.y;
            if(param3 != null)
            {
