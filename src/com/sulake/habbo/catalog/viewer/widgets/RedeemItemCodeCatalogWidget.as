package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_946.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_946 = null;
         }
         if(this.var_947 != null)
         {
            this.var_947.removeEventListener(WindowKeyboardEvent.const_180,this.windowKeyEventProcessor);
            this.var_947 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_946 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_946 != null)
         {
            this.var_946.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_947 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_947 != null)
         {
            this.var_947.addEventListener(WindowKeyboardEvent.const_180,this.windowKeyEventProcessor);
         }
         return true;
      }
