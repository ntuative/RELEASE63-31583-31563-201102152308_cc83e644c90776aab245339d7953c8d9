   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1099.add(MarketPlaceOfferState.const_1077,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1099.add(MarketPlaceOfferState.const_515,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1099.add(MarketPlaceOfferState.const_169,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            if(_loc11_.status == MarketPlaceOfferState.const_515)
            {
               _loc5_++;
            }
            _loc4_ = this.var_1099.getValue(_loc11_.status);
            if(_loc4_)
            {
