package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1696:IProductData;
      ...
      {
         super();
         this.var_1695 = param1.productType;
         this.var_1698 = param1.furniClassId;
         this.var_1361 = param1.extraParam;
         this.var_1360 = param1.productCount;
         this.var_1697 = param1.expiration;
