package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1949:int = 10;
      ...
      private const const_1657:uint = 4.293848814E9;
      
      private const const_1658:uint = 4.294967295E9;
      
      private const const_1950:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1487 = _loc1_.stuffTypes;
            this.var_700 = _loc1_.boxTypes;
            this.var_699 = _loc1_.ribbonTypes;
            this.var_1042 = this.var_1487[0];
            this.var_339 = this.var_700[0];
            this.var_338 = this.var_699[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_338 < 0)
         {
            this.var_338 = this.var_699.length - 1;
         }
         if(this.var_338 > this.var_699.length - 1)
         {
            this.var_338 = 0;
         }
         if(this.var_339 < 0)
         {
            this.var_339 = this.var_700.length - 1;
         }
         if(this.var_339 > this.var_700.length - 1)
         {
            this.var_339 = 0;
         }
         var _loc1_:int = this.var_700[this.var_339] * 1000 + this.var_699[this.var_338];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_87.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1042,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1487;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1042);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_700[this.var_339]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_699[this.var_338]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_87,this.var_1303,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_87.offerId,this.var_1303);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               if(this.var_2207 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_216)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1949)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2207 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_392:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_560 == null)
         {
            this.var_560 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_560.procedure = this.suggestionsEventHandler;
         }
         if(this.var_238 == null || this.var_560 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_560.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1950;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1657) : uint(this.const_1658);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1042;
               }
            }
            _loc4_++;
         }
