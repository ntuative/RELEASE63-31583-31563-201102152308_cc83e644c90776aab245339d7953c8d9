package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1672:String = "badge_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1339 = param7;
         this.var_2283 = param5;
         this.var_1671 = param6;
         this.var_83 = param10;
         this._assets = param8;
         ...
         this._window.center();
         this.var_2286 = this.var_83.getBadgeName(this.var_283);
         this.var_2287 = this.var_83.getBadgeDesc(this.var_283);
         this.var_2284 = this.var_83.getAchievementNameForFacebook(this.var_283,this.var_392.userName,this.var_392.realName,this.var_1338);
         this.var_2288 = this.var_83.getAchievementDescForFacebook(this.var_283,this.var_392.userName,this.var_392.realName,this.var_1338);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2282 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_83.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1656.toString());
         this.var_83.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1339.toString());
         this.var_83.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1339.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1671;
         var _loc17_:String = this.var_1671 == 0 ? "pixels" : "activitypoints";
         this.var_83.registerParameter(_loc16_,_loc17_,"" + this.var_2283);
         _loc15_.caption = this.var_83.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1672);
         ...
         if(this.var_1339 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_283,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_283,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_283,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_83.registerParameter(param1,"badge_name",this.var_2286);
         this.var_83.registerParameter(param1,"badge_desc",this.var_2287);
         this.var_83.registerParameter(param1,"badge_name_fb",this.var_2284);
         this.var_83.registerParameter(param1,"badge_desc_fb",this.var_2288);
         this.var_83.registerParameter(param1,"level",this.var_1338.toString());
         this.var_83.registerParameter(param1,"name",this.var_392.userName);
         return this.var_83.registerParameter(param1,"realname",this.var_392.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_392.events.removeEventListener(BadgeImageReadyEvent.const_148,this.onBadgeImageReady);
            this.var_392 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_283)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1672);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_283,this._feedTitleFb,this.var_2282,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2285));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_283,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_283,"client.skip_post"));
               this.dispose();
               return;
         }
      }
