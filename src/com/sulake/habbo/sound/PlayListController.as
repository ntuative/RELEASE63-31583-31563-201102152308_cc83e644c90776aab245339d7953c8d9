package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1948:String = "type_sound_machine";
      
      private const const_1666:String = "type_jukebox";
      
      private var var_593:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_700,this.onSongFinishedPlayingEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_673,this.onSoundMachinePlayEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_695,this.onSoundMachineStopEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_814,this.onJukeboxInitEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_557,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_700,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_88)
            {
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_673,this.onSoundMachinePlayEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_695,this.onSoundMachineStopEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_814,this.onJukeboxInitEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_557,this.onDisposeEvent);
               this.var_88 = null;
            }
            if(this.var_396)
            {
      ...
      {
         this.startPlaying(this.const_1948);
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_396[this.var_279] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_396.getValue(this.var_279) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         ...
         _loc2_.volume = this.var_593.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_593.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
      ...
      {
         if(this.var_1605 == this.const_1666)
         {
            this.var_75.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc7_ == null)
            {
               _loc7_ = this.var_593.loadTraxSong(_loc3_.id,_loc3_.data);
