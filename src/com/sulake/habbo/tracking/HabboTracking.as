package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1181:IHabboWindowManager;
      
      private var var_170:IHabboToolbar;
      
      private var var_172:IHabboHelp;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1446 = new Array(const_961);
         var _loc4_:int = 0;
         while(_loc4_ < const_961)
         {
            this.var_1446[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1383,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1463,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1181)
            {
               this.var_1181.release(new IIDHabboWindowManager());
               this.var_1181 = null;
            }
            if(this.var_287)
            {
            ...
            if(this.var_201)
            {
               if(!this.var_201.disposed)
               {
                  ...
                  Component(this.var_201).events.removeEventListener(HabboFriendListTrackingEvent.const_374,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_172)
            {
               if(!this.var_172.disposed)
               {
                  this.var_172.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_172.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_172.release(new IIDHabboHelp());
               this.var_172 = null;
            }
            if(this.var_170)
            {
               ...
               {
                  this.var_170.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_182)
         {
            ...
            this.trackLoginStep(HabboLoginTrackingStep.const_1370);
            if(this.var_182)
            {
               if(this.var_633 != null)
               {
                  this.var_633.configure(this.var_182);
               }
               if(this.var_634 != null)
               {
               ...
               {
                  this.var_632.configure(this.var_182);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_859,this.onConnectionEvent);
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1358);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1622);
               break;
            case HabboCommunicationEvent.const_859:
               this.trackLoginStep(HabboLoginTrackingStep.const_1522,String(this._communication.port));
               break;
      ...
      {
         this.var_1181 = IHabboWindowManager(param2);
         if(this.var_1181)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_182)
            {
               if(this.var_182.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1446)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1090);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1090,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_201).events.addEventListener(HabboFriendListTrackingEvent.const_374,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_374:
      ...
      {
         this.var_172 = param2 as IHabboHelp;
         this.var_172.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_172.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2666)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1479);
            this.var_2666 = true;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_272,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_287 = param2 as IAdManager;
         this.var_287.events.addEventListener(AdEvent.const_521,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_170 = param2 as IHabboToolbar;
         this.var_170.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1871;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1871);
         }
         if(this.var_518 > -1 && _loc2_ - this.var_518 > 15000)
         {
            ++this.var_1872;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1872);
         }
         this.var_518 = _loc2_;
         if(this.var_263 != null)
         {
            this.var_263.update(param1,this.var_518);
         }
         if(this.var_262 != null)
         {
         ...
         if(this.var_634 != null)
         {
            this.var_634.trackUpdate(param1,this,this.var_518);
         }
         if(this.var_633 != null)
         {
            this.var_633.update(this.var_518);
         }
      }
   }
}
