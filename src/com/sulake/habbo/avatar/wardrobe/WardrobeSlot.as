package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_618 && this.var_1430)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_86,this.var_953,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_34,parseInt(FigureData.const_610));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1430 && this.var_618 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this._controller.handler.saveWardrobeOutfit(this.var_1838,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_618)
               {
                  this._controller.loadAvatarInEditor(this.var_618,this.var_953,this._controller.clubMemberLevel);
               }
         }
      }
