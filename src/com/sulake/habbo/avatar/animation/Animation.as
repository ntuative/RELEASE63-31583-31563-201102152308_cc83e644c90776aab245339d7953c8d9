package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1820:AvatarDataContainer;
      
      private var var_1413:Array;
      
      private var var_1818:DirectionDataContainer;
      
      private var var_1819:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1682 = String(param2.@desc);
         }
         else
         {
            this.var_1682 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1411.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1820 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1413.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1818 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1819 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1412.push(String(_loc5_.@id));
            }
         }
         ...
         if(param2.hasOwnProperty("HabboNavigatorCom_tag_r_reactive_png"))
         {
            this._overrideFrames = new Map();
            this.var_613 = new Map();
            for each(_loc7_ in param2.HabboNavigatorCom_tag_r_reactive_png)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@HabboNavigatorCom_tag_r_reactive_png;
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_612,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
