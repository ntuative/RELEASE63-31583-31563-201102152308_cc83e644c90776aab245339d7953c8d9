package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_895:AvatarActionManager;
      ...
      private var var_941:ActionDefinition;
      
      private var var_494:String;
      
      private var var_1367:PartOffsetData;
      ...
      {
         this.var_1367.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_895 = new AvatarActionManager(param1,this.var_494,param2);
         this.var_941 = this.var_895.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         if(this.var_411.parse(param1))
         {
            if(this.var_494 == AvatarType.const_117)
            {
               this.var_411.getPartDefinition("ri").appendToFigure = true;
               this.var_411.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      {
         return this.var_895.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_895.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_895.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_592[param1] = new Dictionary();
         }
         if(this.var_592[param1][param2])
         {
            return this.var_592[param1][param2];
         }
         this.var_592[param1][param2] = this.var_354.getMandatorySetTypeIds(param1,param2);
         return this.var_592[param1][param2];
      }
      ...
      {
         return this.var_895.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_411.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_411.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1556[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_411.getActiveParts(param3.definition);
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_941;
                           }
                           _loc12_ = this.var_411.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_411.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1367.getOffset(param1,param2,param3,param4,param5,param6);
      }
