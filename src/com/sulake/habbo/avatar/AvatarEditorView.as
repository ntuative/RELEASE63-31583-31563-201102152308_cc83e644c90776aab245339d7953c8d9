package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1929:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1043 = [];
         this.var_1307 = [AvatarEditorFigureCategory.const_775,AvatarEditorFigureCategory.const_46,AvatarEditorFigureCategory.const_221,AvatarEditorFigureCategory.const_798,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_99];
         super();
         ...
         this.var_397 = new Timer(1000);
         this.var_397.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_397.stop();
            this.var_397.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_397 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1043.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1043.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2208 = this.canChangeOutfit();
            this.var_397.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1043.indexOf(_loc4_.name) < 0)
            {
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1609 == AvatarEditorSideCategory.const_99 || this.var_2209))
         {
      ...
      {
         if(this.var_1609 == AvatarEditorSideCategory.const_99)
         {
            this.var_2209 = false;
            this.setSideContent(AvatarEditorSideCategory.const_869);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_869:
               break;
            case AvatarEditorSideCategory.const_428:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_428);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_465)
         {
            ...
            this.var_465 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_465.procedure = this.stripClubDialogEventProc;
            this.var_465.center();
         }
         else
         {
