package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1343:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1344:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1186:AvatarEditorHandler;
      ...
      private var var_967:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_520)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_186)
         {
            ...
            _loc2_.loadAvatarData(const_1343,FigureData.const_74);
            _loc3_.loadAvatarData(const_1344,FigureData.FEMALE);
            this.var_95 = new Map();
            this.var_520 = new Map();
            this.var_95.add(AvatarEditorFigureCategory.const_775,new BodyModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_46,new HeadModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_221,new TorsoModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_798,new LegsModel(this));
            ...
            this.var_520.add(AvatarEditorSideCategory.const_99,new WardrobeModel(this));
            this.var_520.add(AvatarEditorSideCategory.const_428,new ClubPromoModel(this));
            this.var_186 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_967.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_967.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_775);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_520.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_519 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_967 = this.var_519.getFigureData(AvatarType.const_117);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1186 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_636[this.var_953];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1187 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1342)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_519.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_519.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1604)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1187 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1187 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_520.getValue(AvatarEditorSideCategory.const_99);
      }
