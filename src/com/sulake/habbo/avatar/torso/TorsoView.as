   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_248,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_64,FigureData.const_182,_windowManager,_assetLibrary);
         ...
         if(var_64 && var_135 == "")
         {
            var_64.switchCategory(FigureData.const_182);
         }
      }
