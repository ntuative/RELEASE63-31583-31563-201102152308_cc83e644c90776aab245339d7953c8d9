package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_534:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_46)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1402);
            if(_loc3_ != null)
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_941);
         this.getCache().resetBodyPartCache(this.var_941);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1401 = this._structure.sortActions(this.var_314);
         ...
         {
            this.var_729 = this._structure.getCanvasOffsets(this.var_1401,this._scale,this.var_86);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1401)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_213)
               {
                  this.var_879 = true;
               }
