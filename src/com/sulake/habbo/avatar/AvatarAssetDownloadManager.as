package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_1945:int = 100;
      
      private const const_1393:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_849 = new Timer(this.const_1945,1);
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_394)
         {
            ...
            this.var_394.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_394)
         {
            ...
            this.var_394.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1289.indexOf("?") > 0)
            {
               _loc2_ = this.var_1289 + "&retry=" + this.var_851;
            }
            else
            {
               _loc2_ = this.var_1289 + "?retry=" + this.var_851;
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2177,this._assets);
            ...
            for each(_loc4_ in _loc2_.part)
            {
               ...
               _loc6_.push(_loc3_);
               this.var_1033[_loc5_] = _loc6_;
            }
         }
      }
      
      public function method_1(param1:IAvatarFigureContainer) : Boolean
      {
         if(!this.var_1589)
         {
            return false;
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1589)
         {
            this.var_1032.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_448[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_448[_loc3_] = _loc6_;
            }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         while(_loc6_ < this.var_691.length)
         {
            _loc5_ = this.var_691[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_691.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_849.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_690.length > 0 && this.var_691.length < this.const_1393)
         {
            _loc1_ = this.var_690[0];
            _loc1_.startDownloading();
            this.var_691.push(this.var_690.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.method_1 && this.var_690.indexOf(param1) == -1 && this.var_691.indexOf(param1) == -1)
         {
