package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1320:String = "Default";
      
      private static const const_1321:int = 2;
      
      private static const const_1319:String = AvatarSetType.const_34;
      ...
      protected var var_786:Boolean;
      
      protected var var_729:Array;
      ...
      protected var var_534:IAvatarDataContainer;
      
      protected var var_314:Array;
      
      protected var var_43:BitmapData;
      
      private var var_941:IActiveActionData;
      ...
      private var var_2711:String = null;
      
      private var var_2713:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1319,const_1321);
         this.var_314 = new Array();
         this.var_941 = new ActiveActionData(AvatarAction.const_348);
         this.var_941.definition = this._structure.getActionDefinition(const_1320);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_786)
         {
            ...
            if(this.var_785)
            {
               for each(_loc2_ in this.var_785)
               {
                  _loc2_.dispose();
               }
      ...
      {
         param2 += this.var_1806;
         if(param2 < AvatarDirectionAngle.const_1062)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_266.length == 1 && this.var_86 == this.var_1987)
         {
            return this.var_86 + this.var_524 + this.var_643 % 4;
         }
         if(this.var_266.length == 2)
         {
            for each(_loc1_ in this.var_266)
            {
               ...
               {
                  return this.var_86 + this.var_524 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_643 % 11;
                  return this.var_86 + "_" + this.var_1987 + this.var_524 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2712 || param2 != this.var_2711 || param1 != this.var_2713)
         {
            this.var_2712 = param3;
            this.var_2711 = param2;
            this.var_2713 = param1;
            this.var_1913 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1241 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1241)
            {
               this.var_43.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_271.definition.geometryType,this.var_86);
         this.var_43.lock();
         ...
         {
            if(this.var_534.paletteIsGrayscale)
            {
               ...
               this.var_43 = _loc13_;
               this.var_43.paletteMap(this.var_43,this.var_43.rect,new Point(0,0),this.var_534.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_271.definition.geometryType,this.var_86);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_314.push(new ActiveActionData(param1,param2,this.var_643));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_271 = this.var_941;
         this.var_271.definition = this.var_941.definition;
         this.resetBodyPartCache(this.var_941);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_524 = "";
         this.var_266 = this._structure.sortActions(this.var_314);
         if(this.var_266 == null)
         {
         ...
         {
            this.var_729 = this._structure.getCanvasOffsets(this.var_266,this._scale,this.var_86);
            ...
            if(this.var_1465 != this.var_524)
            {
               _loc1_ = true;
               this.var_1465 = this.var_524;
            }
         }
         this.var_1403 = true;
         return _loc1_;
         ...
         for each(_loc1_ in this.var_266)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_192 = this.var_192.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1806 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_534 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_292 || _loc1_.actionType == AvatarAction.const_213 || _loc1_.actionType == AvatarAction.const_402)
               {
                  this.var_879 = true;
               }
            }
