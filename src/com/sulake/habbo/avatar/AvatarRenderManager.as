package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1991:String = "hd-99999-99999";
      ...
      private var var_783:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_631 = RenderMode.const_1546;
         ...
         this.var_101.add(AvatarType.const_117,_loc4_);
         ...
         this.var_783 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_307.init();
         this.var_783.init();
         _loc2_ = this.var_101.getValue(AvatarType.const_117) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_101.getValue(AvatarType.const_117) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_920)
         {
            if(this.var_2696 && this.var_2695 && this.var_2697)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_228.method_1(param1);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_101.getValue(AvatarType.const_117) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_228.method_1(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1906)
         {
            this.var_1906 = new AvatarFigureContainer(this.const_1991);
         }
      ...
      {
         var _loc3_:AvatarStructure = this.var_101.getValue(AvatarType.const_117) as AvatarStructure;
