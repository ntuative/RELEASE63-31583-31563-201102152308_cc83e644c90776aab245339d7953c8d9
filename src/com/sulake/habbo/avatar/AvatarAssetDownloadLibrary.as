package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1650:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_2;
         this._assets = param4;
         this.var_872 = String(param1);
         this._revision = String(param2);
         this.var_1328 = param3 + this.var_872 + ".swf";
         this.var_1328 = this.var_1328.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_872 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_872);
            this._state = name_3;
         }
      }
      ...
      {
         this._state = var_1650;
         var _loc1_:URLRequest = new URLRequest(this.var_1328);
      ...
      {
         var _loc1_:String = this.var_872;
         return _loc1_ + (!!this.method_1 ? "[x]" : "[ ]");
      }
   }
}
