package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1775:AvatarSet;
      
      private var var_756:Dictionary;
      
      private var var_1776:Dictionary;
      
      private var var_1128:Matrix4x4;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         this.var_1128 = new Matrix4x4();
         this.var_756 = new Dictionary();
         this.var_1776 = new Dictionary();
         this.var_1775 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_756[String(_loc6_.@id)] = _loc7_;
            this.var_1776[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function removeDynamicItems() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_756)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1775.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1775.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_153[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_756[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_756[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_756[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1776[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1128 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1128);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1128 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1128,this.var_925,param4);
         }
         return [];
      }
