package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private var var_627:RoomEventData;
      ...
      {
         var _loc2_:int = 0;
         this.var_2648 = param1.limit;
         this.var_1441 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1441 >= this.var_2648;
      }
