package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1164:RoomCreateViewCtrl;
      ...
      private var var_2588:RoomThumbnailRenderer;
      
      private var var_984:GuestRoomPasswordInput;
      
      private var var_367:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1164 = new RoomCreateViewCtrl(this);
         this.var_2588 = new RoomThumbnailRenderer(this);
         this.var_984 = new GuestRoomPasswordInput(this);
         this.var_367 = new GuestRoomDoorbell(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_312,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_303.startSearch(Tabs.const_234,Tabs.const_373,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_303.startSearch(Tabs.const_303,Tabs.const_258);
         this.var_431.getTab(Tabs.const_303).tabPageDecorator.tabSelected();
      }
