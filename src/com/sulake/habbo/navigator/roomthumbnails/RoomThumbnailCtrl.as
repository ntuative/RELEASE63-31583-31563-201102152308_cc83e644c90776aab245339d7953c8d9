package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1909 = IButtonWindow(this.find("top_tab"));
         this.var_1908 = IButtonWindow(this.find("obj_tab"));
         ...
         Util.setProcDirectly(this.var_1909,this.onTopTabButton);
         Util.setProcDirectly(this.var_1908,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_64.mode = ThumbnailEditorModel.const_56;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1907,this.var_64.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1909,this.var_64.mode != ThumbnailEditorModel.const_56);
         this.setEnabled(this.var_1908,this.var_64.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_top",this.var_64.mode == ThumbnailEditorModel.const_56);
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_312,HabboWindowStyle.const_40,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
