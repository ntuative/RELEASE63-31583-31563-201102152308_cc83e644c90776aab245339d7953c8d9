package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_408.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_408)
         {
            this.var_408.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_408.reset();
            this.var_408 = null;
         }
         if(this.var_348)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_52 == null)
         {
            this.var_52 = IWindowContainer(this._navigator.getXmlWindow(this.var_992));
         ...
         this.var_52.x = _loc2_.x + this.var_2146 + param1.width;
