package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2719:ITextWindow;
      ...
      private var var_2718:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1926.visible = true;
         this.var_2719.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_788.setText(param1.eventDescription);
         this.var_983.setText(this.getTagFromEvent(param1,1));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_788.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_983.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_788.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1926 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2719 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1925 = ITextWindow(this.find("create_caption"));
            this.var_1927 = ITextWindow(this.find("edit_caption"));
            this.var_1472 = IButtonWindow(this.find("create_button"));
            this.var_1474 = IButtonWindow(this.find("edit_button"));
            this.var_2718 = IButtonWindow(this.find("cancel_button"));
            ...
            Util.setProcDirectly(this.var_2718,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_788 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_983 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
