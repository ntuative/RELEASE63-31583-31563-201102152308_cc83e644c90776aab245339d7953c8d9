package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1074:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_722,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_723,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1073)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1669;
            if(_loc2_ - this.var_1073 >= this.var_1666)
            {
               _loc3_ = this.var_1074;
               _loc4_ = this.var_1668;
               this.var_1073 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1074 >> 16 & 255;
               _loc11_ = this.var_1074 >> 8 & 255;
               _loc12_ = this.var_1074 & 255;
               _loc13_ = (_loc2_ - this.var_1073) / this.var_1666;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1667 + (this.var_1668 - this.var_1667) * _loc13_;
               this._color = _loc3_;
               this.var_1669 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_609:
               param2.setString(RoomObjectVariableEnum.const_707,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_795:
               param2.setString(RoomObjectVariableEnum.const_880,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_725:
               param2.setString(RoomObjectVariableEnum.const_731,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_558:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_218)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_787:
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1014:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1187:
               param2.setNumber(RoomObjectVariableEnum.const_722,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_723,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1048,int(param1.bgOnly));
         this.var_1337 = this._color;
         this.var_1667 = this.var_1669;
         this.var_1074 = _loc3_;
         this.var_1668 = _loc4_;
         this.var_1073 = getTimer();
         this.var_1666 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1565,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1605,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1528,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_153 || _loc13_ == RoomPlaneData.const_304)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
