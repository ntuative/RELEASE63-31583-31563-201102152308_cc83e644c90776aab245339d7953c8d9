package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1476:int = const_394;
      ...
      public static const const_297:int = const_119;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_682,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_623,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1850 == const_119)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_623);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_623,this.var_30.width,this.var_623);
         }
