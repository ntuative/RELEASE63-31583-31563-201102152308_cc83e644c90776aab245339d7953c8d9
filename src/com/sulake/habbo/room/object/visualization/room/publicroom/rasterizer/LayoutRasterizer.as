package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_742:IGraphicAssetCollection;
      
      private var var_1877:XMLList;
      
      private var _offsetX:int;
      
      private var var_1079:int;
      
      private var var_2684:Vector3d;
      ...
      private var var_974:Boolean = true;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_973)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1453 = this.var_42.getValue(this.var_973);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2684 = new Vector3d(-0.5,0.5,0);
         this.var_974 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2684);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_42.getValue(this.var_973);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1896 = RoomObjectVariableEnum.const_976;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1896 = RoomObjectVariableEnum.const_1046;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1198 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1198 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_42.getValue(this.var_973);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2682 && param3 == this.var_2683)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1198 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1198 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1896);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_546;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = this.var_742.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_434.indexOf(_loc10_) >= 0 && this.var_974)
            {
               param1 = this.var_434.indexOf(_loc10_);
               if(this.var_640[param1] != "")
               {
                  _loc9_ = this.var_742.getAsset(this.var_640[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_639[param1] != -1)
               {
                  param2.alpha = this.var_639[param1];
               }
               this.var_434.splice(param1,1);
               this.var_640.splice(param1,1);
               this.var_639.splice(param1,1);
      ...
      {
         this.var_974 = true;
         var _loc3_:int = this.var_434.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_434.push(param1);
            this.var_640.push(param2);
            this.var_639.push(-1);
         }
         else
         {
            this.var_640[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_434.push(param1);
            this.var_640.push("");
            this.var_639.push(param2);
         }
         else
         {
            this.var_639[_loc3_] = param2;
         }
      }
   }
}
