package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_1780:int = 16777216;
      
      private var var_2767:int = 69069;
      
      private var var_2768:int = 5;
      ...
      {
         var _loc1_:int = this.var_2767 * this.var_1781 + this.var_2768;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1780;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1780 * param2);
      }
   }
}
