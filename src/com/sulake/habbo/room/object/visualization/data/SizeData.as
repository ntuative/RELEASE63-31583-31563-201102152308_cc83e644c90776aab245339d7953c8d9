package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1152:DirectionData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_257 != null)
         {
            ...
            {
               _loc2_ = this.var_257.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_760,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_257.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_257.add(String(_loc7_),_loc3_);
            this.var_1811 = -1;
            this.var_1152 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1098);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1086);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1406 / 2) % 360 / this.var_1406;
         if(this.var_257.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_257.getKey(_loc5_)) * this.var_1406;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_257.getKey(_loc4_));
         }
         return const_1503;
      }
      
      private function method_3(param1:int) : DirectionData
      {
         if(param1 == this.var_1811)
         {
            return this.var_1152;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_257.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_760;
         }
      ...
      {
         var _loc3_:* = null;
         _loc3_ = this.method_3(param1);
         if(_loc3_ != null)
         {
            return _loc3_.getTag(param2);
         }
         return LayerData.const_767;
      }
