package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1488:String = "cone";
      
      public static const const_1387:String = "plane";
      
      public static const const_1495:String = "sphere";
      ...
      private var var_916:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_915 = 0;
         this.var_807 = false;
         this.init(0,0,0,this._direction,this.var_2434,this.var_916,this.var_2429,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2431)
         {
            switch(this.var_2433)
            {
               case const_1488:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_916,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_359.push(_loc4_);
            ++this.var_915;
            _loc10_++;
         }
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_915 < this.var_1372)
         {
            if(this.age % this.var_2430 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_915 < this.var_1372)
         {
            ...
            this.y = (2 - this.var_248) * this.y - (1 - this.var_248) * this.lastY + this.var_1749 * this.var_916 * this.var_916;
         ...
         for each(_loc2_ in this.var_359)
         {
            ...
            _loc2_.y = (2 - this.var_248) * _loc2_.y - (1 - this.var_248) * _loc2_.lastY + this.var_1749 * this.var_916 * this.var_916;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_359.splice(this.var_359.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
