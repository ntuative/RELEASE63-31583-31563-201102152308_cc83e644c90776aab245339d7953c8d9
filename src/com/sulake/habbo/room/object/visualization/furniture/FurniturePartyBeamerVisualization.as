package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_956:int = 15;
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(_loc2_ != null)
         {
            this.var_771[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_771[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_771.length == 2)
            {
               return this.var_771[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_771.length == 2)
            {
               return this.var_771[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1179[param2];
         var _loc4_:int = this.var_1176[param2];
         var _loc5_:int = this.var_1178[param2];
         var _loc6_:Number = this.var_1177[param2];
         if(param1 == 32)
         {
            _loc7_ = const_956;
         }
         ...
         this.var_1179[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1177[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1179.push(Math.random() * _loc2_ * 1.5);
         this.var_1179.push(Math.random() * _loc2_ * 1.5);
         this.var_1176 = new Array();
         this.var_1176.push(1);
         this.var_1176.push(-1);
         this.var_1178 = new Array();
         this.var_1178.push(const_1336);
         this.var_1178.push(ANIM_SPEED_SLOW);
         this.var_1177 = new Array();
         this.var_1177.push(this.getRandomAmplitudeFactor());
         this.var_1177.push(this.getRandomAmplitudeFactor());
      }
