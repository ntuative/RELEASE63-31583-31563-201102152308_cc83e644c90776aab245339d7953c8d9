package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_936:int = 1000;
      
      private static const const_1303:String = "pet_experience_bubble_png";
      
      private static const const_1304:int = 0;
      
      private static const const_1302:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this.var_280.commonAssets.getAssetByName(const_1303) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_359);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_257);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_355) > 0;
            this.var_1643 = _loc3_.getNumber(RoomObjectVariableEnum.const_289);
            this.var_1325 = _loc3_.getNumber(RoomObjectVariableEnum.const_656);
            this.var_2046 = _loc3_.getNumber(RoomObjectVariableEnum.const_681);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1752)
            {
               this.var_1752 = _loc6_;
               this.var_2448 = this.var_1752.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1325 > 0)
            {
               _loc2_ = param1 - this.var_1325;
               if(_loc2_ < const_936)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_936 * 0) * 255);
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_242)
         {
            this.var_242 = param1;
            _loc3_ = this.var_280.getAnimationForPosture(var_187,param1);
            this.setAnimationForIndex(const_1304,_loc3_);
         }
         if(param2 != this.var_1324)
         {
            this.var_1324 = param2;
            _loc3_ = this.var_280.getAnimationForGesture(var_187,param2);
            this.setAnimationForIndex(const_1302,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2448);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_595)
         {
            ...
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_534.length)
               {
                  return null;
               }
