package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_959:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2656 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_958)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2655 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2658 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2654 = param2.getKey("public.room.dynamic.download.url","");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_515.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_515.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               this.var_628.add(_loc3_,_loc4_);
            ...
            _loc8_ = this.var_630.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_630.remove(_loc7_);
               this.var_630.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2657)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_674));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_517 != null)
         {
            ...
            this.var_517.add(param1,param2);
         }
         if(this.var_516 != null)
         {
            this.var_516.remove(param2);
            this.var_516.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_516 != null)
         {
            _loc2_ = this.var_516.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_278;
         }
         return RoomObjectCategoryEnum.const_154;
      }
      ...
      {
         return [const_414,const_603,const_605,const_604,TILE_CURSOR,const_959];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_628.getValue(param1) as String;
      ...
      {
         var _loc3_:Map = this.var_960[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_199 != null && this.var_199.hasWorldType(const_327 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_173 || param1 == RoomObjectVisualizationEnum.const_70 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2654 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_369,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_199 = this.var_1443.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_659,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2656.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1360);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_369,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_561,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_432[param1];
            this.var_960.add(_loc6_,_loc3_);
         }
      }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_773.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_773.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_515.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_773.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_515.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_515.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_251 && _loc5_ != RoomObjectLogicEnum.const_173)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(this.getObjectCategory(const_327 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_199.getWorldHeightScale(const_327 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_199 != null)
         {
            return this.var_199.getWorldScale(const_327 + param1);
         }
         return 32;
      }
