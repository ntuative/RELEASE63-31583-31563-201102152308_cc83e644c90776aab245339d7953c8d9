package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_579:String = "temporary_room";
      ...
      private static const const_1237:String = "tile_cursor";
      
      private static const const_904:int = -3;
      
      private static const const_1238:String = "selection_arrow";
      ...
      private var var_859:IRoomRendererFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_859.release(new IIDRoomRendererFactory());
            this.var_859 = null;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_45 != null)
         {
            ...
            _loc2_ = this.var_45.getRoom(this.getRoomIdentifier(this.var_96,this.var_97));
         ...
         while(_loc2_ < this.var_333.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_96 || _loc6_ != this.var_97 || !this.var_1039)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_684) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_856) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_774) + 0.5;
               ...
               _loc32_.offset(-_loc6_.screenOffsetX,-_loc6_.method_2);
               ...
               if(_loc31_ != null)
               {
                  ...
                  if(_loc11_)
                  {
                     ...
                     _loc6_.method_2 = -_loc9_.location.y;
                  }
                  else
                  {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_45 != null)
         {
            ...
            this.var_45.addObjectUpdateCategory(RoomObjectCategoryEnum.const_278);
            this.var_45.addObjectUpdateCategory(RoomObjectCategoryEnum.const_79);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_859 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_674,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_156);
         }
         this.initializeRoomManager();
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_674)
         {
            this.var_2189 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_287.events.addEventListener(AdEvent.const_521,this.showRoomAd);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_25 != null)
         {
            ...
            {
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_227,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_490,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_465,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_137,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_608,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_440,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_485,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_429,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_552,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_484,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_481,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_62,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_509,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_418,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_272,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_475,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_398,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_328,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_488,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_1020,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_565,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_25 == null || this.var_505 == null || this.var_45 == null || this.var_859 == null || this._communication == null || this.var_156 == null || !this.var_2189)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_462 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_892,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1135,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_529,param1,param2));
            }
            else
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1135);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_655,1,true);
            _loc13_ = parseInt(this.var_156.getKey("ads.billboard.displayDelayMillis","1000"));
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_324,const_580,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_655,0,true);
         }
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_856,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_684,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_774,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1182,_loc14_,true);
               }
            }
         }
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_795,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_725,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_558,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_218);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_971,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_905,const_1237,RoomObjectCategoryEnum.const_278);
         _loc7_.createRoomObject(const_904,const_1238,RoomObjectCategoryEnum.const_278);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_324,RoomObjectCategoryEnum.const_79);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_795,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_725,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1527,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1187,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1014,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_802,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_859.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1024;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_971);
      ...
      public function getRoomCanvasScreenOffset(param1:int, param2:int, param3:int) : Point
      {
         ...
         return new Point(_loc4_.screenOffsetX,_loc4_.method_2);
      }
      ...
      {
         var _loc8_:int = param2 - this.var_1297;
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1039 = true;
               this.var_858 = false;
               this.var_2188 = this.var_1297;
               this.var_2190 = this.var_1296;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1039)
            {
               if(!this.var_858)
               {
                  _loc8_ = param2 - this.var_2188;
                  _loc9_ = param3 - this.var_2190;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_572,this.var_96,this.var_97,-1,RoomObjectCategoryEnum.const_154));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_70 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_324,const_580);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1295);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1297 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1296 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1295);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1295);
         if(_loc1_ != null)
         {
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_655) != 0)
         {
            return false;
         }
         if(this.var_70 != null)
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_904,RoomObjectCategoryEnum.const_278);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_905,RoomObjectCategoryEnum.const_278);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_397,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_351,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1082,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_970,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1124,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_321,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_397,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_351,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1024,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_321,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1025) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1028);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_558,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_787,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_321,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_289);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_833,this.var_96,this.var_97,param2,param3));
            }
         }
      }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_167,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               _loc8_.addPlane(RoomPlaneData.const_153,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_153,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_707,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_880,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_731,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_558,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null) : ImageResult
      {
         ...
         var _loc9_:IRoomInstance = this.var_45.getRoom(const_579);
         if(_loc9_ == null)
         {
            _loc9_ = this.var_45.createRoom(const_579,null);
            if(_loc9_ == null)
            {
               return _loc8_;
            }
         }
         var _loc10_:int = this.var_694.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_259,int(param2));
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_472,param7);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
         ...
         {
            this.var_1038.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1001,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc10_ != null)
                  {
                     ...
                     if(_loc11_ != null)
                     {
                        _loc9_.offset(_loc11_.width / 2 + _loc11_.screenOffsetX,_loc11_.height / 2 + _loc11_.method_2);
                        return _loc9_;
                     }
                  }
               }
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_96,this.var_97,const_324,RoomObjectCategoryEnum.const_79,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_45.getRoom(const_579);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1001);
               ...
               this.var_694.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1038.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_340,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_976,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1046,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1186,RoomObjectVariableEnum.const_340,param1.clickUrl);
