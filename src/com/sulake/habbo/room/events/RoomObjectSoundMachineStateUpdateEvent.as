package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_673:String = "ROSM_SOUND_MACHINE_SWITCHED_ON";
      
      public static const const_695:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
      
      public static const const_814:String = "ROSM_JUKEBOX_INIT";
