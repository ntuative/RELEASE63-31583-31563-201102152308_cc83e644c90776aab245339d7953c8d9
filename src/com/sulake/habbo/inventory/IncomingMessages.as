package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_337);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         {
            _loc3_.method_7(_loc4_);
         }
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_122);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_371))
         {
