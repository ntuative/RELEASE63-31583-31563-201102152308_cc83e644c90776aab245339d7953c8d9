package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2734:BitmapData;
      
      private const const_1947:int = 8947848;
      
      private const const_1946:int = 13421772;
      
      private const const_1675:Number = 1;
      
      private const const_1676:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1432));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1977);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1676;
               _loc1_.blend = this.const_1676;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(this.var_1978 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2734;
               _loc5_.visible = true;
            }
            else
            {
