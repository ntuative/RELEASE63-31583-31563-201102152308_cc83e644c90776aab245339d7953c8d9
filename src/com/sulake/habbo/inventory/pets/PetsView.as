package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      {
         var _loc2_:PetsGridItem = this.var_621.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_621 == null || this.var_621.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_621.getWithIndex(0));
      }
      
      public function method_7(param1:PetData) : void
      {
         if(param1 == null)
         {
            return;
         }
         if(this.var_621.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_621.add(param1.id,_loc2_);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_64.switchCategory(FurniModel.const_44);
                  break;
               case "tab_wall":
                  this.var_64.switchCategory(FurniModel.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_46);
               }
               _loc8_.dispose();
            }
         }
