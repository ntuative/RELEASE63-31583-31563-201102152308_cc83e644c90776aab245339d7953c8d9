package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1117:IRoomSession;
      ...
      private const const_1960:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_480,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_48.getValue(InventoryCategory.const_75));
      }
      ...
      {
         return EffectsModel(this.var_48.getValue(InventoryCategory.const_691));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_48.getValue(InventoryCategory.const_280));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_48.getValue(InventoryCategory.const_337));
      }
      ...
      {
         return PetsModel(this.var_48.getValue(InventoryCategory.const_122));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_48.getValue(InventoryCategory.const_371) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_480,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_95:
               this.var_1117 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_480:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_392 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_170)
         {
            return;
         }
         ...
         this.var_48.add(InventoryCategory.const_371,_loc1_);
         ...
         this.var_48.add(InventoryCategory.const_691,_loc4_);
         ...
         this.var_48.add(InventoryCategory.const_337,_loc5_);
         ...
         this.var_48.add(InventoryCategory.const_122,_loc8_);
         this.var_186 = true;
         if(this.var_2426)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_911.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_911.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_911.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1960);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_667));
      }
