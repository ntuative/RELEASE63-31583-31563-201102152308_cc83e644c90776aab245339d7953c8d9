package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1432:uint = 9;
      ...
      public static const const_482:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_53.updateItemList(this.var_763);
         this.var_53.updateItemList(this.var_1426);
      ...
      public function close() : void
      {
         if(this.var_689)
         {
            if(this._state != const_177 && this._state != const_266)
            {
      ...
      {
         this.var_53.setMinimized(param1 != InventoryCategory.const_75);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_764 + " OTHER: " + this.var_1162);
         ...
         {
            case const_177:
               if(param1 == const_168 || param1 == const_266)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_53.alertPopup(TradingView.const_1066);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_763)
            {
               this.var_764 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_763)
            {
               this.var_53.alertPopup(TradingView.const_1053);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_300.length < const_1432)
         {
