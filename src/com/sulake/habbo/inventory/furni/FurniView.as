package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_958:int = 1;
      
      private const const_1688:int = 2;
      
      private const const_1687:int = 3;
      
      private const const_1689:int = 42;
      ...
      private var var_657:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_506.add(FurniModel.const_44,new FurniGridView(this.var_64,FurniModel.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_506.add(FurniModel.const_45,new FurniGridView(this.var_64,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_506.getValue(this.var_421);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_64.getCategoryContent(this.var_421);
         if(!this.var_64.isListInited())
         {
            _loc2_ = this.const_958;
         }
         ...
         if(this.var_2538 == _loc2_)
         {
            return;
         }
         this.var_2538 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_506.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_506.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_506.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_64.getGroupItemInIndex(_loc3_,this.var_421);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_388)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_657 && this.var_657.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         else if(_loc3_ < this.const_1689)
         {
            _loc3_ = this.const_1689;
         }
         else
         {
