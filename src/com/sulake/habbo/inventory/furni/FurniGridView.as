   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_64.toggleItemSelection(this._category,this.var_468.getGridItemIndex(param1.window));
            this.var_564 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_564 != null && this.var_564 == param2 && !this.var_64.isTradingOpen)
         {
