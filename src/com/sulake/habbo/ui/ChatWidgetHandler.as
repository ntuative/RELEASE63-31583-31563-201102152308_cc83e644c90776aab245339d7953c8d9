   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_427 != null)
         {
            ...
            {
               _loc2_ = this.var_427.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1173)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_675,RoomWidgetChatSelectAvatarMessage.const_857];
      }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_427.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_427.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_770 == null)
            {
               ...
               this.var_513.y = 0;
               this.var_513.z = 0;
               this.var_770 = _loc4_.getScreenPoint(this.var_513);
            ...
            this.var_513.y = 0;
            this.var_513.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_513);
            if(_loc8_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_427)
         {
            _loc2_ = this.var_427.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1173.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_86,this);
            if(_loc5_ != null)
            {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1859.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1859.remove(param1);
         if(_loc3_ != null)
         {
            this.method_5(_loc3_);
            if(this.var_306)
            {
