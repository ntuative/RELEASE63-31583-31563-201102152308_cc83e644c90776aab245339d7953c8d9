   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_667,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_877,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_170 != null)
            {
               this.var_170.events.removeEventListener(HabboToolbarEvent.const_67,this.onHabboToolbarEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_667,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_877,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1439)
            {
               ...
               this.var_1439 = _loc2_;
               this.var_1863 = _loc1_;
            }
            else
            {
         ...
         if(this.var_170 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1074,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_668);
         _loc1_.push(RoomWidgetDanceMessage.const_784);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_828);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_685);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_390);
         _loc1_.push(RoomWidgetStopEffectMessage.const_748);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1453);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1126);
         _loc1_.push(RoomWidgetToolbarMessage.const_794);
         _loc1_.push(RoomWidgetToolbarMessage.const_699);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_393);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1623);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1010);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_686);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_643);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_665);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1465);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_643:
               ...
               break;
            case RoomWidgetWaveMessage.const_668:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_784:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_828:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_390:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1190)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_170,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_685:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1644:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1385:
                        break;
                     default:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1011:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1563:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1126:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_686:
               ...
               break;
            case RoomWidgetToolbarMessage.const_794:
               ...
               if(this.var_170)
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_699:
               ...
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_426,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_393:
            ...
            case RoomWidgetClothingChangeMessage.const_338:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_849));
               break;
            default:
