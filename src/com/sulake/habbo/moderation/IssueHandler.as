package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_142:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_455:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_142.getHighestPriorityIssue();
         this.var_455 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_1014 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_455.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_142.reportedUserId > 0)
         {
            this.var_1014.load(_loc4_,this.var_142.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_142.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_142.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_61 != null && this.var_61.issueManager != null && this.var_142 != null)
         {
            this.var_61.issueManager.removeHandler(this.var_142.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_142.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_142.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_142.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.releaseBundle(this.var_142.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_142.getHighestPriorityIssue().issueId;
         this.var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_61,WindowTracker.const_1117,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_142.getHighestPriorityIssue();
            this.var_455 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
            this.var_455.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
