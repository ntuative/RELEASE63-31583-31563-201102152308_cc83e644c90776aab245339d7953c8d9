package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_820:Array = [];
      
      private static var var_1528:int = 200;
      ...
      {
         this.var_667 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_820.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_667.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_820.length < var_1528)
         {
            ...
            param1.width = this.var_667.width;
            param1.height = this.var_667.height;
            var_820.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1252)
         {
