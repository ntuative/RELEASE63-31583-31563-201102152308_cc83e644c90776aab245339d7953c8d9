package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1032:String = "issue_bundle_open";
      
      public static const const_634:String = "issue_bundle_my";
      
      public static const const_995:String = "issue_bundle_picked";
      
      public static const const_1585:int = 15000;
       
      
      private var var_61:ModerationManager;
      
      private var var_594:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_594 = new IssueBrowser(this,this.var_61.windowManager,this.var_61.assets);
         this.var_1106 = [];
         this.var_1105 = [];
         this.var_901 = new Map();
         this.var_2395 = parseInt(this.var_61.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1735 = new Timer(const_1585,0);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_335 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_594 == null || !this.var_594.isOpen())
         {
            this.var_61.soundManager.playSound(HabboSoundTypesEnum.const_1015);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_902.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_902.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1425)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_99)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_902.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2396++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_902.add(param1.issueId,_loc2_);
         ...
         if(this.var_1106.indexOf(param1.issueId) != -1)
         {
            ...
            {
               if(param1.state == IssueMessageData.const_335)
               {
         ...
         {
            _loc6_ = this.getBundles(const_634);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2395);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_901.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_901.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_902.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_99.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
         ...
         for each(_loc4_ in this.var_99)
         {
            switch(param1)
            {
               case const_1032:
                  ...
                  break;
               case const_634:
                  if(_loc4_.state == IssueMessageData.const_335 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_901.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_901.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_335 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_901.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
