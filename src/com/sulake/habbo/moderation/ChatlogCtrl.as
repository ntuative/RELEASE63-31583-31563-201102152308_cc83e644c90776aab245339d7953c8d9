package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_972:Array = [];
      
      private static var var_1892:int = 1000;
      
      private static var var_971:Array = [];
      
      private static var var_1891:int = 200;
      ...
      private var var_1750:IMessageComposer;
      ...
      {
         this.var_776 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_775 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1750);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_972.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_971.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_776.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_971.length < var_1891)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_776.width;
            param1.height = this.var_776.height;
            var_971.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1893[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1450.getValue(param2.chatterName))
            {
               this.var_1450.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1450.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1449)
         {
