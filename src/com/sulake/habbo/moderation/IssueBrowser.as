package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1988:String = "my_issues";
      
      private const const_1989:String = "open_issues";
      
      private const const_1987:String = "picked_issues";
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1988:
               ...
               {
                  this.var_1875 = new MyIssuesView(this.issueManager,this,this.var_264.container);
               }
               return this.var_1875;
            case this.const_1989:
               if(this.var_1874 == null)
               {
                  this.var_1874 = new OpenIssuesView(this.issueManager,this,this.var_264.container);
               }
               return this.var_1874;
            case this.const_1987:
               if(this.var_1873 == null)
               {
                  this.var_1873 = new PickedIssuesView(this.issueManager,this,this.var_264.container);
               }
