package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1011:IDropMenuWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_373));
      ...
      public function populate() : void
      {
         ...
         this.var_1011 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1011);
         this.var_1011.procedure = this.onSelectTemplate;
         this.var_821 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1253 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1254 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_657,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1582,_loc2_,this.var_461.text,"",""));
         if(this.var_1253.isSelected || this.var_1254.isSelected || this.var_821.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1253.isSelected,this.var_1254.isSelected,this.var_821.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1617);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1443);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1011.selection];
         if(_loc3_ != null)
         {
            this.var_622 = false;
            this.var_461.text = _loc3_;
         }
      }
   }
}
