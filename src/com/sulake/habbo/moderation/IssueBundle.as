package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_746:IssueMessageData = null;
      
      private var var_747:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2443 = param2.pickerUserId;
         this.var_2442 = param2.pickerUserName;
         this.var_1312 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1122 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1121;
         }
         if(this.var_746 == null || param1.timeStamp < this.var_746.timeStamp)
         {
            this.var_746 = param1;
         }
         if(this.var_747 == null || param1.priority > this.var_747.timeStamp)
         {
            this.var_747 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1122 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1121;
            }
            if(this.var_746 == _loc2_)
            {
               this.var_746 = null;
            }
            if(this.var_747 == _loc2_)
            {
               this.var_747 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_747;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_746;
         if(_loc2_ == null)
         {
