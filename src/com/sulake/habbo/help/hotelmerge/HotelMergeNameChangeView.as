package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_751)
         {
            this.var_751 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_751)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_752)
         {
            this.var_752 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_752)
            {
               return;
            }
