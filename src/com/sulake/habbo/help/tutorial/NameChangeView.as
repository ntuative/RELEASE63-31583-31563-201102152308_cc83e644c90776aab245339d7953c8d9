package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1757:uint = 11129827;
      ...
      private var var_1126:NameSuggestionListRenderer;
      ...
      private function showSelectionView() : void
      {
         if(!this.var_751)
         {
            this.var_751 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_751)
            {
               return;
            }
            this._window.content.addChild(this.var_751);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_752)
         {
            this.var_752 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_752)
            {
               return;
            }
            this._window.content.addChild(this.var_752);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_752.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_503;
         }
         this.showView(this.var_752);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_793:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_986:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_987 || param1 == ChangeUserNameResultMessageEvent.var_986)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1126 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1126.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_87);
         }
      }
