package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_782:FaqCategory;
      ...
      {
         super();
         this.var_782 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_780 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_781 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_782.hasItem(param1))
         {
            this.var_782.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_782.hasItem(param1))
         {
            return this.var_782.getItem(param1);
         }
         if(this.var_780.hasItem(param1))
         {
