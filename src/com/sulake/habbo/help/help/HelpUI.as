package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102152302));
         this.var_170 = param5;
         this.var_103 = new Map();
         this.var_103.add(HabboHelpViewEnum.const_1613,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_188,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_491,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_290,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_103.add(HabboHelpViewEnum.const_399,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_705,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_243,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_103.add(HabboHelpViewEnum.const_1150,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_103.add(HabboHelpViewEnum.const_996,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_103.add(HabboHelpViewEnum.const_678,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_243:
               ...
               break;
            case CallForHelpResultEnum.const_1093:
               this.showUI(HabboHelpViewEnum.const_996);
               break;
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_103.getValue(HabboHelpViewEnum.const_188) as IHelpViewController;
      ...
      private function createWindow() : void
      {
         ...
         this.var_2005 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2004;
         this._window.width = _loc1_.width + this.var_2005;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_317 == HabboHelpViewEnum.const_188)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_317 == HabboHelpViewEnum.const_188 || this.var_446.length == 0)
         {
            return;
         }
         if(this.var_318 == null)
