package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1741:int = "F".charCodeAt(0);
      
      public static const const_1787:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1601 = param1.followingAllowed && param1.online;
         this.var_618 = param1.figure;
         this.var_1602 = param1.motto;
         this.var_1593 = param1.lastAccess;
         this.var_1362 = param1.categoryId;
         this.var_1594 = param1.realName;
