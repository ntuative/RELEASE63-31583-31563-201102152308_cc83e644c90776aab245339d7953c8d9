package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1002:IAvatarRenderManager;
      
      private var var_654:ISessionDataManager;
      
      private var var_2010:FriendListLookAndFeel;
      
      private var var_431:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1499:OpenedToWebPopup;
      
      private var var_2011:int;
      
      var var_95:FriendCategories;
      
      private var var_319:FriendRequests;
      
      private var var_1498:AvatarSearchResults;
      ...
      {
         this.var_2010 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1498 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1002)
         {
            this.var_1002.release(new IIDAvatarRenderManager());
            this.var_1002 = null;
         }
         if(this.var_887)
         {
         ...
         if(this.var_654)
         {
            this.var_654.release(new IIDSessionDataManager());
            this.var_654 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1499 = new OpenedToWebPopup(this);
         }
         this.var_1499.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_319.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_312,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1002.createAvatarImage(param1,AvatarScaleType.const_86,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_654 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_319 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_95.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1197,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_404,this.getText("friendlist.friends.offlinecaption")));
         ...
         this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_404);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_374));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_319.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_319.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_431.findTab(FriendListTab.const_96).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_319.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_431.findTab(FriendListTab.const_96);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1498.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_431.findTab(FriendListTab.const_96);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_654 || !this.var_319)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_654.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_319.vipLimit;
         }
         else if(this.var_654.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_319.clubLimit;
         }
         if(_loc2_ > this.var_319.limit)
         {
            this.var_319.limit = _loc2_;
         }
      }
