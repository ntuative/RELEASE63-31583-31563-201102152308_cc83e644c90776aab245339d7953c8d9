package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_658 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_658.procedure = this.onSearchInput;
         this.var_658.addEventListener(WindowKeyboardEvent.const_180,this.onSearchStrInput);
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_658.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_658.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_658.text;
