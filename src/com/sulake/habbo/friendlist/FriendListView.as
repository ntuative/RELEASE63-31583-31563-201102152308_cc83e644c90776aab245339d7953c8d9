package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1660:String = "noconvinfo";
      
      private static const const_1659:String = "messageinput";
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1262 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1262.prepare(this.var_866);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_984,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1198,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_636,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_662,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_636,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_662,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1261 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1261.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1539 == -1 ? 0 : int(this.var_17.height - this.var_1539);
         var _loc4_:int = this.var_1541 == -1 ? 0 : int(this.var_17.width - this.var_1541);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1035,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_636,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_984,false);
         ...
         this.var_1539 = this.var_17.height;
         this.var_1541 = this.var_17.width;
