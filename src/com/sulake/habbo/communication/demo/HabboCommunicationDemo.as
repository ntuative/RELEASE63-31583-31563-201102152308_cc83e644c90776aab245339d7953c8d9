package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2550:PseudoRandom;
      ...
      private const const_1691:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_611 = param1;
            this.var_50.initConnection(HabboConnectionType.const_235);
         }
      }
      ...
      {
         if(this.var_50 && this.var_156 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_223 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_156.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_156.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_223.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_156.getKey("use.sso.ticket") == "1";
         this.var_611 = this.var_156.getKey("sso.ticket",null);
         this.var_1807 = this.var_156.getKey("flash.client.url","");
         this.var_2551 = this.var_156.getKey("external.variables.txt","");
         if(this.var_223 == null)
         {
            this.var_223 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_50.mode = HabboConnectionType.const_115;
            if(this.var_611)
            {
               this.var_50.initConnection(HabboConnectionType.const_235);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_462,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_50.mode = HabboConnectionType.const_1168;
            }
         }
         this.var_50.initConnection(HabboConnectionType.const_235);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_859);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2550 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_50.mode)
         {
            case HabboConnectionType.const_115:
               ...
               this.var_223.loadBannerImage(_loc7_ + "?token=" + this.var_1404,this.onHotelViewBannerLoaded);
               break;
            ...
            case HabboConnectionType.const_1430:
               ...
               this.var_507 = new DiffieHellman(new BigInteger(this.var_156.getKey("connection.development.prime"),16),new BigInteger(this.var_156.getKey("connection.development.generator"),16));
               this.var_507.init(this.var_942);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2550);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1807,this.var_2551));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1691,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2549)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1404);
