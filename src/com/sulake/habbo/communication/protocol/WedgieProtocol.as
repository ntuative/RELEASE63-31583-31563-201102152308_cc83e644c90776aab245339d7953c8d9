package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1603:uint = 2;
       
      
      private var var_1440:IProtocolEncoder;
      
      private var var_1082:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1440 = new WedgieEncoder();
         this.var_1082 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1082.getID(_loc4_);
