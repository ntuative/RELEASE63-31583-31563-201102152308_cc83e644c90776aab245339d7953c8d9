package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1425:String = "%";
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1478);
      }
      ...
      {
         var _loc2_:String = this.var_1166[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1166[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_1166[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1844.indexOf(param1) < 0 || param3)
         {
            this.var_1166[param1] = param2;
         }
         if(param3)
         {
            this.var_1844.push(param1);
         }
      }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1425);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1425,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
