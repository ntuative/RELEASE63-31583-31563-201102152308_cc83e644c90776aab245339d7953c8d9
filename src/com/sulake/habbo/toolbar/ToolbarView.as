package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1160:Boolean = true;
      
      private var var_1161:Number = 1;
      
      private var var_1424:Number = 0;
      
      private var var_1830:Number = 15;
      
      private var var_1831:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2771 = new Array();
         ...
         this.var_225 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_991,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1160 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1160)
         {
         ...
         this.var_1161 = _loc6_.toolbar.@margin_top;
         this.var_1424 = _loc6_.toolbar.@margin_bottom;
         this.var_1830 = _loc6_.toolbar.@min_group_margin;
         this.var_1831 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_259,param1,param2,this._window,this.var_282);
         this.createGroupsFromXmlList(_loc8_,this.var_615,param1,param2,this.var_225,this.var_282);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_157,this.var_509,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_509);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_157,this.var_509);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_157,this.var_509);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_615.length)
         {
            _loc2_ = this.var_615[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_225.x = this.var_157 + this.var_1831;
               this.var_225.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_225.x = 0;
               this.var_225.y = this.var_157 + this.var_1831;
         ...
         _loc4_ -= this.var_1424;
         _loc4_ -= this.var_1161;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1161;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_259.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1830,(this._window.height - _loc5_ * _loc8_ - this.var_1161 - this.var_1424) / (this.var_259.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1830,(this._window.width - _loc5_ * _loc8_ - this.var_1161 - this.var_1424) / (this.var_259.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_259.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_509;
