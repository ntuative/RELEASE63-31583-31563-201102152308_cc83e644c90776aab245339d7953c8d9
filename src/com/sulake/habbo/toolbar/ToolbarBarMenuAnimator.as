package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1236:Number = 25;
      
      private static const const_1277:Number = 90;
      
      private static const const_901:int = 50;
      
      private static const const_1235:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1284:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_681 = new Timer(const_1236);
         this.var_681.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_328[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_901 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_901 || param1.desktop.height - param1.y < const_1235;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1284.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_328.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1284.getIconLoc(param1.iconId);
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_389,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_265,this.windowEventListener);
      }
      ...
      {
         if(this.var_328.indexOf(param1) > -1)
         {
            if(const_199)
            {
            ...
            else
            {
               ...
               this.var_328.splice(this.var_328.indexOf(param1),1);
            }
         }
      }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_328.length)
         {
            _loc2_ = this._itemList[this.var_328[_loc7_]];
            if(_loc2_.active)
            {
