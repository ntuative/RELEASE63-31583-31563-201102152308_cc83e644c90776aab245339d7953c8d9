package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            this.var_976 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_978.push(_loc11_);
                  this.var_975.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_978.push(new XML());
               this.var_975.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_975[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1460 == true || this.var_977 == 0)
         {
            if(this.var_978.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_978.length)
               {
                  this._frame = 0;
                  ++this.var_977;
               }
      ...
      {
         return this.var_1460 == false && this.var_977 == 1 && this.var_1489 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_975.length)
         {
            _loc2_ = this.var_975[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_976.width),Math.max(param2.height,this.var_976.height));
            _loc3_.copyPixels(this.var_976,this.var_976.rect,new Point(0,0));
