package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1162:String = "AssetLibraryReady";
      
      public static const const_659:String = "AssetLibraryLoaded";
      
      public static const const_1352:String = "AssetLibraryUnloaded";
      
      public static const const_1448:String = "AssetLibraryLoadError";
      
      private static var var_295:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_498;
         this.var_416 = new Dictionary(false);
      ...
      {
         if(this._file == param1.url && this.var_920)
         {
            if(!this.var_917 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_748,this.var_601);
            }
            this.var_917 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1162));
         }
         else
         {
      ...
      {
         var _loc2_:Class = this.var_919[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1058,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1176,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1094,this.assetLoadEventHandler);
      ...
      {
         return this.var_151[param1] != null || (this.var_601 != null ? this.var_601[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_295.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_295[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_416.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_416[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_295[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_416[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_295)
            {
               _loc3_ = AssetTypeDeclaration(var_295[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_416)
         {
            _loc3_ = AssetTypeDeclaration(this.var_416[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_295)
            {
               _loc4_ = AssetTypeDeclaration(var_295[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_416)
         {
            _loc4_ = AssetTypeDeclaration(this.var_416[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_920 = true;
         dispatchEvent(new Event(AssetLibrary.const_659));
         dispatchEvent(new Event(AssetLibrary.const_1162));
         if(this.var_917)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1448));
         this.var_40 = null;
      }
