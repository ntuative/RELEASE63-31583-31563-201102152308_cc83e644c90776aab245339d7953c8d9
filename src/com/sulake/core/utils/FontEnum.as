package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_578:Map = new Map();
      
      private static const const_322:Map = new Map();
      
      private static var var_1012:Boolean = false;
      ...
      {
         return const_578.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1012)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_578.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1012 = true;
         }
