package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_953:uint = 8;
      
      private static const const_1327:String = "skin";
      
      private static const const_1332:String = "bitmap";
      
      private static const const_1329:String = "fill";
      
      private static const const_1328:String = "text";
      
      private static const const_1331:String = "label";
      
      private static const const_1330:String = "shape";
      ...
      private var var_2623:Dictionary;
      
      private var var_2624:Dictionary;
      
      private var var_2622:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2623 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1847,this.var_2623);
         this.var_2624 = new Dictionary();
         this.var_2622 = new Dictionary();
         StateCodeTable.fillTables(this.var_2624,this.var_2622);
         this.var_426 = new Dictionary();
         this.var_426[const_1327] = BitmapSkinRenderer;
         this.var_426[const_1332] = BitmapDataRenderer;
         this.var_426[const_1329] = FillSkinRenderer;
         this.var_426[const_1328] = TextSkinRenderer;
         this.var_426[const_1331] = LabelRenderer;
         this.var_426[const_1330] = ShapeSkinRenderer;
         ...
         if(var_316 == null)
         {
            ...
            var_316.push(WindowState.const_85);
            var_316.push(WindowState.const_52);
            var_316.push(WindowState.const_84);
            var_316.push(WindowState.const_83);
            var_316.push(WindowState.const_103);
            var_316.push(WindowState.const_92);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1847[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_956[param1] = new Array(const_953);
         }
         this.var_956[param1][param2] = param3;
         if(this.var_955[param1] == null)
         {
            this.var_955[param1] = new Array(const_953);
         }
         this.var_955[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_189)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_955[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_189)
