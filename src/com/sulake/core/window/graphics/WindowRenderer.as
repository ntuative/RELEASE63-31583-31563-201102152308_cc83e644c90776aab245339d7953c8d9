package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1281:Rectangle;
      
      private var var_274:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1566 = new Point();
         this.var_1281 = new Rectangle();
         this.var_274 = new Rectangle();
         this.var_327 = new Dictionary(true);
         this.var_944 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_678 = null;
            for(_loc1_ in this.var_327)
            {
               delete this.var_327[_loc1_];
            }
            this.var_327 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_274.x = param2.x - param1.x;
            this.var_274.y = param2.y - param1.y;
            this.var_274.width = param2.width;
            this.var_274.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  this.var_274.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_274,WindowRedrawFlag.const_1049);
      ...
      {
         var _loc2_:WindowRendererItem = this.var_327[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_327[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_944);
            this.var_327[param1] = _loc2_;
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_678.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_678.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_274.x = _loc3_.dirty.x;
               this.var_274.y = _loc3_.dirty.y;
               this.var_274.width = _loc3_.dirty.width;
               this.var_274.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_274,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1566,this.var_1281))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1566,this.var_1281))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1281);
