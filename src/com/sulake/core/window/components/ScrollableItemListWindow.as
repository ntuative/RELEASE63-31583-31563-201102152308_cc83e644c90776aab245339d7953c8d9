package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_405:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_405)
         {
            this.var_405.removeEventListener(WindowEvent.const_306,this.scrollBarEventProc);
            this.var_405.removeEventListener(WindowEvent.const_265,this.scrollBarEventProc);
            this.var_405 = null;
         }
         if(this.var_1075)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1075)
         {
            this.var_1075 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_405)
         {
            this.var_405 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_405)
            {
               this.var_405.addEventListener(WindowEvent.const_306,this.scrollBarEventProc);
               this.var_405.addEventListener(WindowEvent.const_265,this.scrollBarEventProc);
            }
         }
         return this.var_405;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_265)
         {
            this.hideScrollBar();
         }
      }
