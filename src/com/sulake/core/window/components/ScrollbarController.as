package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1249:String = "increment";
      
      private static const const_1248:String = "decrement";
      
      private static const const_909:String = "slider_track";
      
      private static const const_581:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_164 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_455;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_457,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_47,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_457,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_868 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_909) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_581) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_581:
         ...
         if(param2.type == WindowNotifyEvent.const_496)
         {
            if(this.var_18 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_471)
         {
            ...
            else if(param2.name == const_1248)
            {
               if(this.var_18)
               {
                  this.var_1051 = true;
            ...
            else if(param2.name == const_909)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_581).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_868) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_868) as IScrollableWindow;
               if(_loc1_)
               {
