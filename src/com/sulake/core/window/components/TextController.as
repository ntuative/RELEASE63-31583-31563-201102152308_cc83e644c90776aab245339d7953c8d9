package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      private var var_387:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_387,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_387 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_387,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_194);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_876 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_387);
      }
      ...
      {
         return new Rectangle(this.var_794 * this.maxScrollH,this.var_528 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_387);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1149) ? new PropertyStruct(PropertyDefaults.const_755,this._field.antiAliasType,PropertyStruct.const_50,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1174) : PropertyDefaults.const_1507);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1185 ? new PropertyStruct(PropertyDefaults.const_793,this._autoSize,PropertyStruct.const_50,true,PropertyDefaults.const_1115) : PropertyDefaults.const_1389);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_973 ? new PropertyStruct(PropertyDefaults.const_1030,this._field.gridFitType,PropertyStruct.const_50,true,PropertyDefaults.const_983) : PropertyDefaults.const_1614);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_661) ? new PropertyStruct(PropertyDefaults.const_395,this._field.textColor,PropertyStruct.const_141,true) : PropertyDefaults.const_1101);
         _loc1_.push(this.var_387 != TextStyleManager.const_194 ? new PropertyStruct(PropertyDefaults.const_362,this.var_387,PropertyStruct.const_50,true,PropertyDefaults.const_885) : PropertyDefaults.const_1203);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_889 ? new PropertyStruct(PropertyDefaults.const_242,this.var_39.left,PropertyStruct.const_38,true) : PropertyDefaults.const_466);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_650 ? new PropertyStruct(PropertyDefaults.const_267,this.var_39.top,PropertyStruct.const_38,true) : PropertyDefaults.const_569);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_817 ? new PropertyStruct(PropertyDefaults.const_252,this.var_39.right,PropertyStruct.const_38,true) : PropertyDefaults.const_431);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_875 ? new PropertyStruct(PropertyDefaults.const_211,this.var_39.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_568);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1114 ? new PropertyStruct(PropertyDefaults.const_669,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1560);
