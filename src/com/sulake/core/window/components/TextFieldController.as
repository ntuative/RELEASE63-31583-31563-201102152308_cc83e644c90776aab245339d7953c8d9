package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1234 = param1 == null ? "" : param1;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_331,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_641,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1606);
         _loc1_.push(this.var_1229 != PropertyDefaults.const_1146 ? new PropertyStruct(PropertyDefaults.const_839,this.var_1229,PropertyStruct.const_37,true) : PropertyDefaults.const_1571);
         _loc1_.push(_field.selectable != PropertyDefaults.const_998 ? new PropertyStruct(PropertyDefaults.const_847,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1449);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_969 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1480);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_839:
                  this.var_1229 = _loc2_.value as Boolean;
                  if(this.var_1229)
                  {
               ...
               case PropertyDefaults.const_641:
                  ...
                  break;
               case PropertyDefaults.const_980:
