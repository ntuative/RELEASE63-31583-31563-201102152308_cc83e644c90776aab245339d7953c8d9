package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1207:String = "_TITLE";
      
      private static const const_1325:String = "_HEADER";
      
      private static const const_1323:String = "_CONTENT";
      
      private static const const_1324:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1419:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1207) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1419 = findChildByTag(const_1325) as IHeaderWindow;
            if(!this.var_1419)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_177 = findChildByTag(const_1323) as IWindowContainer;
            if(!this.var_177)
            {
      ...
      {
         return findChildByTag(const_1324) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_269);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_252,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_211,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
