package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_838:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_672:String;
      
      private var var_1022:String = null;
      
      private var var_1558:StyleSheet = null;
      ...
      {
         this.var_672 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1022 == param2)
         {
            return;
         }
         param1.var_1022 = param2;
         param1.var_1558 = null;
         if(param1.var_1022 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1022);
            param1.var_1558 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_727.indexOf(param1) > -1)
         {
            this.var_672 = param1;
         }
      }
      ...
      {
         return this.var_672 == LinkTarget.const_31 ? defaultLinkTarget : this.var_672;
      }
      ...
      public function set method_10(param1:String) : void
      {
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1558;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_672 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_861,this.var_672,PropertyStruct.const_50,true,PropertyDefaults.const_727));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1559);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_861)
            {
               this.var_672 = _loc2_.value as String;
               break;
            }
            if(_loc2_.key == "html_stylesheet")
            {
               this.method_10 = _loc2_.value as String;
               break;
            }
         }
