package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_360:Object = null;
      ...
      {
         return this.var_360 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_387);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_360 != null)
            {
               _loc1_.textColor = uint(this.var_360);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_387 != param1.name)
         {
            this.var_387 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2478 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_360 != _loc2_.color : this.var_360 != null && this.var_360 != PropertyDefaults.const_661) ? new PropertyStruct(PropertyDefaults.const_395,this.var_360,PropertyStruct.const_141,true) : PropertyDefaults.const_1101);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_889)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,this.var_39.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_466);
            }
            if(this.var_39.top != PropertyDefaults.const_650)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,this.var_39.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_569);
            }
            if(this.var_39.right != PropertyDefaults.const_817)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_252,this.var_39.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_431);
            }
            if(this.var_39.bottom != PropertyDefaults.const_875)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_211,this.var_39.bottom,PropertyStruct.const_38,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_395:
                  this.var_360 = _loc2_.value as uint;
                  break;
