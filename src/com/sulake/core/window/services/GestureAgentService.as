package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_270:Function;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_197 = new Timer(40,0);
            this.var_197.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_197.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1228 *= 0.75;
         this.var_1227 *= 0.75;
         if(Math.abs(this.var_1228) <= 1 && Math.abs(this.var_1227) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_270 != null)
         {
            this.var_270(this.var_1228,this.var_1227);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_197.stop();
            this.var_197.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_197 = null;
         }
         if(this._working)
         {
