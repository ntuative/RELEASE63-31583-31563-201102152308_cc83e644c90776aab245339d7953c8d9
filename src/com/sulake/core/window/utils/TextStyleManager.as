package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_194:String = "regular";
      ...
      private static var var_482:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_586:String = "{";
      
      private static const const_587:String = "}";
      
      private static const const_1273:String = "/*";
      
      private static const const_1274:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_194],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_194] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_482.indexOf(_loc4_.name) == -1)
            {
               var_482.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_587);
         if(countSubStrings(param1,const_586) != countSubStrings(param1,const_587))
         {
            throw new Error("Mismatching amount of \"" + const_586 + "\" versus \"" + const_587 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1273) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1274) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_586)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
