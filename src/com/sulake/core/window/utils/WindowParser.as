package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1188:String = "_EXCLUDE";
      
      public static const const_1763:String = "_INCLUDE";
      
      public static const const_1788:String = "_TEMP";
      
      private static const const_1287:String = "layout";
      
      private static const const_929:String = "window";
      
      private static const const_930:String = "variables";
      
      private static const const_928:String = "filters";
      
      private static const const_593:String = "name";
      
      private static const const_1293:String = "style";
      
      private static const const_592:String = "params";
      
      private static const const_1286:String = "tags";
      ...
      private static const const_1292:String = "visible";
      
      private static const const_1294:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1007:String = "blend";
      
      private static const const_1291:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1297:String = "treshold";
      
      private static const const_1290:String = "children";
      
      private static const const_1289:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1296:String = "height_min";
      
      private static const const_1295:String = "height_max";
      
      private static const const_594:String = "true";
      
      private static const const_156:String = "0";
      
      private static const const_1299:String = "$";
      
      private static const const_1281:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1298:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_996:Dictionary;
      
      protected var var_1482:Dictionary;
      
      protected var var_1976:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_996,this.var_1482);
         this.var_1976 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1288,const_48);
         return param1.replace(const_1298,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_996)
            {
               delete this.var_996[_loc1_];
            }
            for(_loc1_ in this.var_1482)
            {
               delete this.var_1482[_loc1_];
            }
            this.var_1976.dispose();
            this.var_1976 = null;
            this.var_16 = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1287)
         {
            ...
            _loc9_ = param1.child(const_928).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1293,variables,style));
         params = uint(this.parseAttribute(xml,const_592,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1286,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_156));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_156));
         rect.width = Number(this.parseAttribute(xml,const_1283,variables,const_156));
         rect.height = Number(this.parseAttribute(xml,const_1282,variables,const_156));
         visible = this.parseAttribute(xml,const_1292,variables,visible.toString()) == const_594;
         caption = unescape(String(this.parseAttribute(xml,const_1294,variables,caption)));
         ...
         if(xml.child(const_592).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_996[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_593)) + "\"!");
               }
               params |= this.var_996[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1281);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1289,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1296,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1295,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_594;
         blend = Number(this.parseAttribute(xml,const_1007,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1291,variables,window.clipping.toString()) == const_594;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1297,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_928).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1188) == -1)
                  {
