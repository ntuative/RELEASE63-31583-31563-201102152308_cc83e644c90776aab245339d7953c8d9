package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_311 = param1;
         if(this.var_311 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_311)
         {
      ...
      {
         return this.var_312 == int.MIN_VALUE && this.var_309 == int.MAX_VALUE && this.var_311 == int.MIN_VALUE && this.var_310 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_311)
            {
               this._target.height = this.var_311;
            }
