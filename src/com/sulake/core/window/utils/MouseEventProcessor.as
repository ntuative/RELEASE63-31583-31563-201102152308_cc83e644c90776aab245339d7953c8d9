   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_651.x || _loc3_.stageY != this.var_651.y)
            {
               this.var_651.x = _loc3_.stageX;
               this.var_651.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_134.groupParameterFilteredChildrenUnderPoint(this.var_651,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_79 != this.var_134 && !this.var_79.disposed)
                  {
                     ...
                     this.var_79 = WindowController(this.var_134);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_79 && !this.var_79.disposed)
                     {
                        ...
                        {
                           this.var_799.mouseEventReceived(_loc3_.type,this.var_79);
                        }
                     }
                  }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_559))
         {
