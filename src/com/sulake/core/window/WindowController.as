package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1093:uint = 0;
      ...
      protected static const const_1654:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1363:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_724 = _loc13_.blend;
            var_443 = _loc13_.var_2720;
      ...
      {
         var_444 = param1;
         var_230 = !!var_444 ? uint(var_230 | var_533) : uint(var_230 & 16777215);
      ...
      {
         var_803 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_567,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_533 = param1 & 4278190080;
         var_230 = !!var_444 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_533 = param1 << 24;
         var_230 = !!var_444 ? uint(var_533 | var_230) : uint(16777215 & var_230);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      
      public function set blend(param1:Number) : void
      {
         var_724 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1007);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_516,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_496,this,this._parent));
            }
            else
            {
               this.var_349.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1016,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_19,var_16,var_11,null,this.var_649,this.properties,var_802.concat(),_id) as WindowController;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2350 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1026,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_806,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_422,this,null));
            }
            if(_loc6_)
            {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1153;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_192:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_468,this,null));
                     if(testParamFlag(WindowParam.const_193,WindowParam.const_163))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_172,WindowParam.const_150))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_493))
                        {
               ...
               case WindowNotifyEvent.const_422:
                  var_16.invalidate(this,var_11.union(var_59),WindowRedrawFlag.const_553);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1017,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_336:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_663,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_236,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_516:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1111);
                  break;
               case WindowNotifyEvent.const_476:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1654) == -1)
                     {
                        _loc8_.style = var_80;
                     }
                  }
               ...
               case WindowNotifyEvent.const_567:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_553);
                     }
                  }
                  else if(var_19 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1434:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1353:
               _loc2_ = "null";
               break;
         ...
         if(this.var_164 && var_443 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1363,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1363,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_163);
         var _loc2_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_150);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
      ...
      {
         if(_state == WindowState.const_425)
         {
            return true;
         }
         _state = WindowState.const_425;
      ...
      public function maximize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_68,true);
         _loc1_.type = WindowNotifyEvent.const_1103;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_664;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1091;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1094 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1094 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_888,this,param1));
         return param1;
      }
