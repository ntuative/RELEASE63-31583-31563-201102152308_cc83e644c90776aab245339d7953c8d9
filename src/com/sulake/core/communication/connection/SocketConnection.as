package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1567:int = 10000;
      ...
      private var var_1044:IEncryption;
      
      private var var_702:IProtocol;
      
      private var _id:String;
      
      private var var_1045:IMessageClassManager;
      
      private var var_299:ICoreCommunicationManager;
      
      private var var_466:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1045 = new MessageClassManager();
         this.var_76 = new Socket();
         this.var_340 = new Timer(const_1567,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_466)
         {
            this.var_466.connectionInit(param1,param2);
         }
      ...
      {
         this.var_299.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1045.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_702.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_466)
         {
            this.var_466.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1044 != null)
         {
            _loc3_ = this.var_1044.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1045.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_702.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_702.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1044 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_702.getMessages(this.var_467,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_466)
               {
                  this.var_466.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1045.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_299.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_299.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_467.writeByte(this.var_76.readUnsignedByte());
         }
      }
