package com.sulake.core.runtime
{
   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.removeLibraryLoader(_loc2_);
         this.error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1404);
      }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     this.error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_864);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               this.error("Invalid component class " + componentString + "!",true,Core.const_864);
               return null;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     this.error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_864);
                  }
               }
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         if(param1.locked)
         {
            param1.events.addEventListener(const_406,this.lockEventHandler);
         }
      ...
      public final function detachComponent(param1:Component) : void
      {
         ...
         while(_loc5_ < this._components.length)
         {
            if(this._components[_loc5_] == param1)
            {
               ...
               param1.events.removeEventListener(const_406,this.lockEventHandler);
               return;
            }
            _loc5_++;
         }
      ...
      private function lockEventHandler(param1:LockEvent) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1.type == const_406)
         {
            _loc2_ = param1.unknown as Component;
            _loc2_.events.removeEventListener(const_406,this.lockEventHandler);
            if(!disposed)
            {
               _loc3_ = new Array();
