package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_406:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1767:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1191:uint = 4;
       
      
      protected var var_720:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1236 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1236);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1484 & const_1191)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_952 = false;
            this._events.dispatchEvent(new LockEvent(const_406,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_720 + "]";
      }
